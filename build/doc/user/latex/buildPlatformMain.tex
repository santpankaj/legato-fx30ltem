...
\{
    ...
    \{
        ...
        \textcolor{keywordflow}{case} \hyperlink{le__sim__interface_8h_a21b9bb7d5e5e7ece213e00738a5bae41affe6278346f2d16ba331f900b58f1ce9}{LE\_SIM\_POWER\_DOWN}:
            sprintf(\textcolor{keywordtype}{string}, \textcolor{stringliteral}{"\(\backslash\)nSIM Card state LE\_SIM\_POWER\_DOWN for SIM card.%d \(\backslash\)n"}, simId);
            \textcolor{keywordflow}{break};
...
\{
    ...
    \{
        ...
        \textcolor{keywordflow}{case} \hyperlink{le__sim__interface_8h_a21b9bb7d5e5e7ece213e00738a5bae41a944435801d6359050dc37092396ca951}{LE\_SIM\_BUSY}:
            ...
            \textcolor{keywordflow}{break};
        \textcolor{keywordflow}{case} \hyperlink{le__sim__interface_8h_a21b9bb7d5e5e7ece213e00738a5bae41affe6278346f2d16ba331f900b58f1ce9}{LE\_SIM\_POWER\_DOWN}:
            \hyperlink{le__log_8h_a23e6d206faa64f612045d688cdde5808}{LE\_INFO}(\textcolor{stringliteral}{"-TEST- New state LE\_SIM\_POWER\_DOWN for SIM card.%d"}, simId);
            \textcolor{keywordflow}{if} (SimPowerCycleStarted)
            \{
                \hyperlink{le__semaphore_8h_abb859411cc58fbcc576c986ef52083b2}{le\_sem\_Post}(SimPowerCycleSemaphore);
            \}
...
L\+E\+\_\+\+G\+N\+S\+S\+\_\+\+N\+M\+E\+A\+\_\+\+M\+A\+S\+K\+\_\+\+D\+E\+B\+UG &&&&&&X &X &\\\cline{1-9}
...
\rowcolor{\tableheadbgcolor}{\bf }&\PBS\centering {\bf A\+R755x }&\PBS\centering {\bf A\+R758x }&\PBS\centering {\bf A\+R759x }&\PBS\centering {\bf A\+R8652 }&\PBS\centering {\bf W\+P750x }&\PBS\centering {\bf W\+P76xx }&\PBS\centering {\bf W\+P77xx }&\PBS\centering {\bf W\+P8548  }\\\cline{1-9}
\endhead
S\+AR backoff state feature &\PBS\centering &\PBS\centering &\PBS\centering &\PBS\centering &\PBS\centering &\PBS\centering X &\PBS\centering X &\PBS\centering \\\cline{1-9}
S\+AR maximum number of states &\PBS\centering &\PBS\centering &\PBS\centering &\PBS\centering &\PBS\centering &\PBS\centering 8 &\PBS\centering 8 &\PBS\centering \\\cline{1-9}
\end{longtabu}
