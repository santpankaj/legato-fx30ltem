...
\{
    ...
    \{
      ...
      \hyperlink{le__gnss__interface_8h_a8d401bb325c46681677bd273433565beab88cd62cd5cb91159ea892a8f3444946}{LE\_GNSS\_COORDINATE\_SYSTEM\_PZ90},
        ...
        \textcolor{keywordflow}{if} (LE\_OK == result)
        \{
            \hyperlink{le__log_8h_a23e6d206faa64f612045d688cdde5808}{LE\_INFO}(\textcolor{stringliteral}{"Latitude: On WGS84 %d, On PZ90 %"} PRId64 \textcolor{stringliteral}{", float %f"},
                    latitude,
                    latitudeOnPZ90,
      ...
      \hyperlink{le__gnss__interface_8h_a8d401bb325c46681677bd273433565beab88cd62cd5cb91159ea892a8f3444946}{LE\_GNSS\_COORDINATE\_SYSTEM\_PZ90},
        ...
        \textcolor{keywordflow}{if} (LE\_OK == result)
        \{
            \hyperlink{le__log_8h_a23e6d206faa64f612045d688cdde5808}{LE\_INFO}(\textcolor{stringliteral}{"Longitude: On WGS84 %d, On PZ90 %"} PRId64 \textcolor{stringliteral}{", float %f"},
                    longitude,
                    longitudeOnPZ90,
    ...
    \{
        ...
        \{
            \hyperlink{le__log_8h_a23e6d206faa64f612045d688cdde5808}{LE\_INFO}(\textcolor{stringliteral}{"Latitude %f"}, (\textcolor{keywordtype}{float})latitude/1000000.0);
        \}
        \textcolor{keywordflow}{else}
        \{
            \hyperlink{le__log_8h_a23e6d206faa64f612045d688cdde5808}{LE\_INFO}(\textcolor{stringliteral}{"Latitude unknown %d"}, latitude);
        \}

        \textcolor{keywordflow}{if} (INT32\_MAX != longitude)
        \{
            \hyperlink{le__log_8h_a23e6d206faa64f612045d688cdde5808}{LE\_INFO}(\textcolor{stringliteral}{"Latitude %f"}, (\textcolor{keywordtype}{float})longitude/1000000.0);
        \}
        \textcolor{keywordflow}{else}
        \{
            \hyperlink{le__log_8h_a23e6d206faa64f612045d688cdde5808}{LE\_INFO}(\textcolor{stringliteral}{"Longitude unknown %d"}, longitude);
        \}

        \textcolor{keywordflow}{if} (INT32\_MAX != hAccuracy)
        \{
            \hyperlink{le__log_8h_a23e6d206faa64f612045d688cdde5808}{LE\_INFO}(\textcolor{stringliteral}{"Horizontal accuracy %f"}, (\textcolor{keywordtype}{float})hAccuracy/100.0);
        \}
        \textcolor{keywordflow}{else}
        \{
            \hyperlink{le__log_8h_a23e6d206faa64f612045d688cdde5808}{LE\_INFO}(\textcolor{stringliteral}{"Horizontal accuracy unknown %d"}, hAccuracy);
        \}
    \}
    ...
    \{
      ...
      \hyperlink{le__gnss__interface_8h_a4517118b39910a4f3f8b08cd5a3a671ca82b77d055b809c8d04bc2824061134e1}{LE\_GNSS\_DATA\_VACCURACY}, dataRes));
        ...
        \textcolor{keywordflow}{if} (LE\_OK == result)
        \{
            \textcolor{keywordflow}{switch}(dataRes)
            \{
                \textcolor{keywordflow}{case} \hyperlink{le__gnss__interface_8h_aaf5d256c75737a2189c8da7bfed5da0da17a6752c8b3a5f04e6e32503eb8336ab}{LE\_GNSS\_RES\_ZERO\_DECIMAL}:
                    \hyperlink{le__log_8h_a23e6d206faa64f612045d688cdde5808}{LE\_INFO}(\textcolor{stringliteral}{"Resolution: %d decimal place, altitude.%f, vAccuracy.%f"},
                            dataRes, (\textcolor{keywordtype}{float})altitude/1000.0, (\textcolor{keywordtype}{float})vAccuracy);
                ...
                \textcolor{keywordflow}{case} \hyperlink{le__gnss__interface_8h_aaf5d256c75737a2189c8da7bfed5da0dacd7af80b5388b3c771774b6af99c775d}{LE\_GNSS\_RES\_ONE\_DECIMAL}:
                    \hyperlink{le__log_8h_a23e6d206faa64f612045d688cdde5808}{LE\_INFO}(\textcolor{stringliteral}{"Resolution: %d decimal place, altitude.%f, vAccuracy.%f"},
                            dataRes, (\textcolor{keywordtype}{float})altitude/1000.0, (\textcolor{keywordtype}{float})vAccuracy/10.0);
                    \textcolor{keywordflow}{break};
                \textcolor{keywordflow}{case} \hyperlink{le__gnss__interface_8h_aaf5d256c75737a2189c8da7bfed5da0da46a03303cc05c2c2d48ae05217ed596e}{LE\_GNSS\_RES\_TWO\_DECIMAL}:
                    \hyperlink{le__log_8h_a23e6d206faa64f612045d688cdde5808}{LE\_INFO}(\textcolor{stringliteral}{"Resolution: %d decimal place, altitude.%f, vAccuracy.%f"},
                            dataRes, (\textcolor{keywordtype}{float})altitude/1000.0, (\textcolor{keywordtype}{float})vAccuracy/100.0);
                    \textcolor{keywordflow}{break};
                \textcolor{keywordflow}{case} \hyperlink{le__gnss__interface_8h_aaf5d256c75737a2189c8da7bfed5da0da4c6bce2bb0595f9683e7333ce637cb5c}{LE\_GNSS\_RES\_THREE\_DECIMAL}:
                    \hyperlink{le__log_8h_a23e6d206faa64f612045d688cdde5808}{LE\_INFO}(\textcolor{stringliteral}{"Resolution: %d decimal place, altitude.%f, vAccuracy.%f"},
                            dataRes, (\textcolor{keywordtype}{float})altitude/1000.0, (\textcolor{keywordtype}{float})vAccuracy/1000.0);
                    \textcolor{keywordflow}{break};
                \textcolor{keywordflow}{default}:
                    \hyperlink{le__log_8h_a23e6d206faa64f612045d688cdde5808}{LE\_INFO}(\textcolor{stringliteral}{"Unknown resolution."});
                    \textcolor{keywordflow}{break};
            \}
        \}
        \textcolor{keywordflow}{else}
    ...
    \textcolor{keywordflow}{if} (LE\_OK == result)
    \{
        \hyperlink{le__log_8h_a23e6d206faa64f612045d688cdde5808}{LE\_INFO}(\textcolor{stringliteral}{"AltitudeOnWgs84: %f"}, (\textcolor{keywordtype}{float})altitudeOnWgs84/1000.0);
      ...
      \hyperlink{le__gnss__interface_8h_a8d401bb325c46681677bd273433565beab88cd62cd5cb91159ea892a8f3444946}{LE\_GNSS\_COORDINATE\_SYSTEM\_PZ90},
        ...
        \textcolor{keywordflow}{if} (LE\_OK == result)
        \{
            \hyperlink{le__log_8h_a23e6d206faa64f612045d688cdde5808}{LE\_INFO}(\textcolor{stringliteral}{"Altitude: On WGS84: %d, On PZ90 %"} PRId64 \textcolor{stringliteral}{", float %f"},
                    altitudeOnWgs84,
                    altitudeOnPZ90,
                    (\textcolor{keywordtype}{float})altitudeOnPZ90/1000.0);
        \}
    \}
    \textcolor{keywordflow}{else}
    \{
    ...
    \textcolor{keywordflow}{if} (LE\_GNSS\_RES\_UNKNOWN == ++DopRes)
    \{
    ...
    \hyperlink{le__log_8h_a23e6d206faa64f612045d688cdde5808}{LE\_INFO}(\textcolor{stringliteral}{"Test SetDataResolution() for hSpeedAccuracy parameter of le\_gnss\_GetHorizontalSpeed() \(\backslash\)}
\textcolor{stringliteral}{            function"});
    ...
    \{
        \hyperlink{le__log_8h_a7cd2daa3d4af1de4d29e0eed95187484}{LE\_ASSERT\_OK}(\hyperlink{le__gnss__interface_8h_a4cfa7d0e69ad462f09af7d6a596cbea5}{le\_gnss\_SetDataResolution}(
      \hyperlink{le__gnss__interface_8h_a4517118b39910a4f3f8b08cd5a3a671cacd35831e4608bef1bcf9d3f38970e278}{LE\_GNSS\_DATA\_HSPEEDACCURACY}, dataRes));
      ...
      hSpeedAccuracy);
        ...
        \{
            ...
            \{
                \textcolor{keywordflow}{case} \hyperlink{le__gnss__interface_8h_aaf5d256c75737a2189c8da7bfed5da0da17a6752c8b3a5f04e6e32503eb8336ab}{LE\_GNSS\_RES\_ZERO\_DECIMAL}:
                    \hyperlink{le__log_8h_a23e6d206faa64f612045d688cdde5808}{LE\_INFO}(\textcolor{stringliteral}{"Resolution: %d decimal place, hSpeed %u - Accuracy %.3f"},
                            dataRes, hSpeed/100, (\textcolor{keywordtype}{float})hSpeedAccuracy);
                    \textcolor{keywordflow}{break};
                \textcolor{keywordflow}{case} \hyperlink{le__gnss__interface_8h_aaf5d256c75737a2189c8da7bfed5da0dacd7af80b5388b3c771774b6af99c775d}{LE\_GNSS\_RES\_ONE\_DECIMAL}:
                    \hyperlink{le__log_8h_a23e6d206faa64f612045d688cdde5808}{LE\_INFO}(\textcolor{stringliteral}{"Resolution: %d decimal place, hSpeed %u - Accuracy %.3f"},
                            dataRes, hSpeed/100, (\textcolor{keywordtype}{float})hSpeedAccuracy/10);
                    \textcolor{keywordflow}{break};
                \textcolor{keywordflow}{case} \hyperlink{le__gnss__interface_8h_aaf5d256c75737a2189c8da7bfed5da0da46a03303cc05c2c2d48ae05217ed596e}{LE\_GNSS\_RES\_TWO\_DECIMAL}:
                    \hyperlink{le__log_8h_a23e6d206faa64f612045d688cdde5808}{LE\_INFO}(\textcolor{stringliteral}{"Resolution: %d decimal place, hSpeed %u - Accuracy %.3f"},
                            dataRes, hSpeed/100, (\textcolor{keywordtype}{float})hSpeedAccuracy/100);
                    \textcolor{keywordflow}{break};
                \textcolor{keywordflow}{case} \hyperlink{le__gnss__interface_8h_aaf5d256c75737a2189c8da7bfed5da0da4c6bce2bb0595f9683e7333ce637cb5c}{LE\_GNSS\_RES\_THREE\_DECIMAL}:
                    \hyperlink{le__log_8h_a23e6d206faa64f612045d688cdde5808}{LE\_INFO}(\textcolor{stringliteral}{"Resolution: %d decimal place, hSpeed %u - Accuracy %.3f"},
                            dataRes, hSpeed/100, (\textcolor{keywordtype}{float})hSpeedAccuracy/1000);
                    \textcolor{keywordflow}{break};
                \textcolor{keywordflow}{default}:
                    \hyperlink{le__log_8h_a23e6d206faa64f612045d688cdde5808}{LE\_INFO}(\textcolor{stringliteral}{"Unknown resolution."});
                    \textcolor{keywordflow}{break};
        ...
        \textcolor{keywordflow}{else}
        \{
            \hyperlink{le__log_8h_a23e6d206faa64f612045d688cdde5808}{LE\_INFO}(\textcolor{stringliteral}{"hSpeed unknown [%u,%.3f]"}, hSpeed, (\textcolor{keywordtype}{float})hSpeedAccuracy);
        \}
    \}

    \textcolor{comment}{// Get vertical speed}
    \hyperlink{le__log_8h_a23e6d206faa64f612045d688cdde5808}{LE\_INFO}(\textcolor{stringliteral}{"Test SetDataResolution() for vSpeedAccuracy parameter of le\_gnss\_GetVerticalSpeed() \(\backslash\)}
\textcolor{stringliteral}{            function"});
    ...
    \{
        \hyperlink{le__log_8h_a7cd2daa3d4af1de4d29e0eed95187484}{LE\_ASSERT\_OK}(\hyperlink{le__gnss__interface_8h_a4cfa7d0e69ad462f09af7d6a596cbea5}{le\_gnss\_SetDataResolution}(
      \hyperlink{le__gnss__interface_8h_a4517118b39910a4f3f8b08cd5a3a671ca02cb88b5dee232010adad12ed34d2667}{LE\_GNSS\_DATA\_VSPEEDACCURACY}, dataRes));
        result = \hyperlink{le__gnss__interface_8h_a37a370cec19610be1f99d9c9db291a1e}{le\_gnss\_GetVerticalSpeed}( positionSampleRef, &vSpeed, &
      vSpeedAccuracy);
        \hyperlink{le__log_8h_ac0dbbef91dc0fed449d0092ff0557b39}{LE\_ASSERT}((LE\_OK == result) || (\hyperlink{le__basics_8h_a1cca095ed6ebab24b57a636382a6c86caef8ecf11fa8556fd2d3ca8faab697717}{LE\_OUT\_OF\_RANGE} == result));
        ...
        \{
            ...
            \{
                \textcolor{keywordflow}{case} \hyperlink{le__gnss__interface_8h_aaf5d256c75737a2189c8da7bfed5da0da17a6752c8b3a5f04e6e32503eb8336ab}{LE\_GNSS\_RES\_ZERO\_DECIMAL}:
                    \hyperlink{le__log_8h_a23e6d206faa64f612045d688cdde5808}{LE\_INFO}(\textcolor{stringliteral}{"Resolution: %d decimal place, vSpeed %d - Accuracy %.3f"},
                            dataRes, vSpeed/100, (\textcolor{keywordtype}{float})vSpeedAccuracy);
                    \textcolor{keywordflow}{break};
                \textcolor{keywordflow}{case} \hyperlink{le__gnss__interface_8h_aaf5d256c75737a2189c8da7bfed5da0dacd7af80b5388b3c771774b6af99c775d}{LE\_GNSS\_RES\_ONE\_DECIMAL}:
                    \hyperlink{le__log_8h_a23e6d206faa64f612045d688cdde5808}{LE\_INFO}(\textcolor{stringliteral}{"Resolution: %d decimal place, vSpeed %d - Accuracy %.3f"},
                            dataRes, vSpeed/100, (\textcolor{keywordtype}{float})vSpeedAccuracy/10);
                    \textcolor{keywordflow}{break};
                \textcolor{keywordflow}{case} \hyperlink{le__gnss__interface_8h_aaf5d256c75737a2189c8da7bfed5da0da46a03303cc05c2c2d48ae05217ed596e}{LE\_GNSS\_RES\_TWO\_DECIMAL}:
                    \hyperlink{le__log_8h_a23e6d206faa64f612045d688cdde5808}{LE\_INFO}(\textcolor{stringliteral}{"Resolution: %d decimal place, vSpeed %d - Accuracy %.3f"},
                            dataRes, vSpeed/100, (\textcolor{keywordtype}{float})vSpeedAccuracy/100);
                    \textcolor{keywordflow}{break};
                \textcolor{keywordflow}{case} \hyperlink{le__gnss__interface_8h_aaf5d256c75737a2189c8da7bfed5da0da4c6bce2bb0595f9683e7333ce637cb5c}{LE\_GNSS\_RES\_THREE\_DECIMAL}:
                    \hyperlink{le__log_8h_a23e6d206faa64f612045d688cdde5808}{LE\_INFO}(\textcolor{stringliteral}{"Resolution: %d decimal place, vSpeed %d - Accuracy %.3f"},
                            dataRes, vSpeed/100, (\textcolor{keywordtype}{float})vSpeedAccuracy/1000);
                    \textcolor{keywordflow}{break};
                \textcolor{keywordflow}{default}:
                    \hyperlink{le__log_8h_a23e6d206faa64f612045d688cdde5808}{LE\_INFO}(\textcolor{stringliteral}{"Unknown resolution."});
                    \textcolor{keywordflow}{break};
        ...
        \textcolor{keywordflow}{else}
        \{
            \hyperlink{le__log_8h_a23e6d206faa64f612045d688cdde5808}{LE\_INFO}(\textcolor{stringliteral}{"vSpeed unknown [%d,%.3f]"}, vSpeed, (\textcolor{keywordtype}{float})vSpeedAccuracy);
        \}
    \}
    ...
    \textcolor{keywordtype}{size\_t} satIdNumElements = \hyperlink{le__basics_8h_a8d8f28a045f43b477cafb67a99894c07}{NUM\_ARRAY\_MEMBERS}(satIdPtr);
    ...
    \textcolor{keywordtype}{size\_t} satConstNumElements = \hyperlink{le__basics_8h_a8d8f28a045f43b477cafb67a99894c07}{NUM\_ARRAY\_MEMBERS}(satConstPtr);
    ...
    \textcolor{keywordtype}{size\_t} satUsedNumElements = \hyperlink{le__basics_8h_a8d8f28a045f43b477cafb67a99894c07}{NUM\_ARRAY\_MEMBERS}(satUsedPtr);
    uint8\_t satSnrPtr[\hyperlink{le__gnss__interface_8h_a507cc757f9629ad56d7a0767c0356e76}{LE\_GNSS\_SV\_INFO\_MAX\_LEN}];
    \textcolor{keywordtype}{size\_t} satSnrNumElements = \hyperlink{le__basics_8h_a8d8f28a045f43b477cafb67a99894c07}{NUM\_ARRAY\_MEMBERS}(satSnrPtr);
    uint16\_t satAzimPtr[\hyperlink{le__gnss__interface_8h_a507cc757f9629ad56d7a0767c0356e76}{LE\_GNSS\_SV\_INFO\_MAX\_LEN}];
    \textcolor{keywordtype}{size\_t} satAzimNumElements = \hyperlink{le__basics_8h_a8d8f28a045f43b477cafb67a99894c07}{NUM\_ARRAY\_MEMBERS}(satAzimPtr);
    uint8\_t satElevPtr[\hyperlink{le__gnss__interface_8h_a507cc757f9629ad56d7a0767c0356e76}{LE\_GNSS\_SV\_INFO\_MAX\_LEN}];
    \textcolor{keywordtype}{size\_t} satElevNumElements = \hyperlink{le__basics_8h_a8d8f28a045f43b477cafb67a99894c07}{NUM\_ARRAY\_MEMBERS}(satElevPtr);
...
\{
    ...
    \textcolor{comment}{// Test le\_gnss\_SetDataResolution() before starting GNSS}
    \hyperlink{le__log_8h_a23e6d206faa64f612045d688cdde5808}{LE\_INFO}(\textcolor{stringliteral}{"Sanity test for le\_gnss\_SetDataResolution"});
    \hyperlink{le__log_8h_ac0dbbef91dc0fed449d0092ff0557b39}{LE\_ASSERT}(\hyperlink{le__basics_8h_a1cca095ed6ebab24b57a636382a6c86cabe505065132f6e8850da6f476d8fb783}{LE\_BAD\_PARAMETER} == 
      \hyperlink{le__gnss__interface_8h_a4cfa7d0e69ad462f09af7d6a596cbea5}{le\_gnss\_SetDataResolution}(\hyperlink{le__gnss__interface_8h_a4517118b39910a4f3f8b08cd5a3a671caeab7ae807136c8d2c1a111b9fcbf87f5}{LE\_GNSS\_DATA\_UNKNOWN},
                                                            
      \hyperlink{le__gnss__interface_8h_aaf5d256c75737a2189c8da7bfed5da0dacd7af80b5388b3c771774b6af99c775d}{LE\_GNSS\_RES\_ONE\_DECIMAL}));
    ...
    \textcolor{comment}{// Test le\_gnss\_SetDataResolution() after starting GNSS}
    \hyperlink{le__log_8h_ac0dbbef91dc0fed449d0092ff0557b39}{LE\_ASSERT}(\hyperlink{le__basics_8h_a1cca095ed6ebab24b57a636382a6c86cabe505065132f6e8850da6f476d8fb783}{LE\_BAD\_PARAMETER} == 
      \hyperlink{le__gnss__interface_8h_a4cfa7d0e69ad462f09af7d6a596cbea5}{le\_gnss\_SetDataResolution}(\hyperlink{le__gnss__interface_8h_a4517118b39910a4f3f8b08cd5a3a671ca82b77d055b809c8d04bc2824061134e1}{LE\_GNSS\_DATA\_VACCURACY},
                                                            LE\_GNSS\_RES\_UNKNOWN));
    ...
    \hyperlink{le__log_8h_ac0dbbef91dc0fed449d0092ff0557b39}{LE\_ASSERT}(\hyperlink{le__basics_8h_a1cca095ed6ebab24b57a636382a6c86cabe505065132f6e8850da6f476d8fb783}{LE\_BAD\_PARAMETER} == 
      \hyperlink{le__gnss__interface_8h_ae7345052efc38f199989aafcd27224e2}{le\_gnss\_SetDopResolution}(LE\_GNSS\_RES\_UNKNOWN));
