...
// Startup code for the executable 'atQmiLinker'.
...
LE_SHARED le_log_SessionRef_t atQmiLinker_exe_LogSession;
LE_SHARED le_log_Level_t* atQmiLinker_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    atQmiLinker_exe_LogSession = log_RegComponent("atQmiLinker_exe", &atQmiLinker_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_atQmiLinker.so");
