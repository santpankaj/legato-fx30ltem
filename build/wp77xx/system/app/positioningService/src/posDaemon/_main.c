...
// Startup code for the executable 'posDaemon'.
...
LE_SHARED const char* _watchdogChain_le_wdog_ServiceInstanceName = "posDaemon.watchdogChain.le_wdog";
LE_SHARED const char* _posDaemon_le_gnss_ServiceInstanceName = "le_gnss";
LE_SHARED const char* _posDaemon_le_pos_ServiceInstanceName = "le_pos";
LE_SHARED const char* _posDaemon_le_posCtrl_ServiceInstanceName = "le_posCtrl";
LE_SHARED const char* _posDaemon_le_cfg_ServiceInstanceName = "posDaemon.posDaemon.le_cfg";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t posDaemon_exe_LogSession;
LE_SHARED le_log_Level_t* posDaemon_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    posDaemon_exe_LogSession = log_RegComponent("posDaemon_exe", &posDaemon_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_le_pa_gnss_default.so");
    LoadLib("libComponent_swiQmi.so");
    LoadLib("libComponent_le_pa_gnss.so");
    LoadLib("libComponent_posDaemon.so");
