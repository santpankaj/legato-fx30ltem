...
// Startup code for the executable 'wifi'.
...
LE_SHARED const char* _wifi_le_wifiClient_ServiceInstanceName = "wifi.wifi.le_wifiClient";
LE_SHARED const char* _wifi_le_wifiAp_ServiceInstanceName = "wifi.wifi.le_wifiAp";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t wifi_exe_LogSession;
LE_SHARED le_log_Level_t* wifi_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    wifi_exe_LogSession = log_RegComponent("wifi_exe", &wifi_exe_LogLevelFilterPtr);
