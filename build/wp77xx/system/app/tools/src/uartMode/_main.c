...
// Startup code for the executable 'uartMode'.
...
LE_SHARED le_log_SessionRef_t uartMode_exe_LogSession;
LE_SHARED le_log_Level_t* uartMode_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    uartMode_exe_LogSession = log_RegComponent("uartMode_exe", &uartMode_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_le_pa_uartMode_default.so");
    LoadLib("libComponent_le_pa_uartMode.so");
    LoadLib("libComponent_uartMode.so");
