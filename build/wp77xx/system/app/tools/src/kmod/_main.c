...
// Startup code for the executable 'kmod'.
...
LE_SHARED const char* _moduleLoad_le_kernelModule_ServiceInstanceName = "kmod.moduleLoad.le_kernelModule";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t kmod_exe_LogSession;
LE_SHARED le_log_Level_t* kmod_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    kmod_exe_LogSession = log_RegComponent("kmod_exe", &kmod_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_moduleLoad.so");
