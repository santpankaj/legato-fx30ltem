...
// Startup code for the executable 'fwupdateDaemon'.
...
LE_SHARED const char* _watchdogChain_le_wdog_ServiceInstanceName = "fwupdateDaemon.watchdogChain.le_wdog";
LE_SHARED const char* _fwupdateDaemon_le_fwupdate_ServiceInstanceName = "le_fwupdate";
LE_SHARED const char* _fwupdateDaemon_le_dualsys_ServiceInstanceName = "le_dualsys";
LE_SHARED const char* _fwupdateDaemon_le_flash_ServiceInstanceName = "le_flash";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t fwupdateDaemon_exe_LogSession;
LE_SHARED le_log_Level_t* fwupdateDaemon_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    fwupdateDaemon_exe_LogSession = log_RegComponent("fwupdateDaemon_exe", &fwupdateDaemon_exe_LogLevelFilterPtr);
