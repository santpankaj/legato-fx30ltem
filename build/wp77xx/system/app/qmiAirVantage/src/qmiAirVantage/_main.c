...
// Startup code for the executable 'qmiAirVantage'.
...
LE_SHARED const char* _qmiAirVantage_le_atServer_ServiceInstanceName = "qmiAirVantage.qmiAirVantage.le_atServer";
LE_SHARED const char* _qmiAirVantage_le_avc_ServiceInstanceName = "qmiAirVantage.qmiAirVantage.le_avc";
LE_SHARED const char* _qmiAirVantage_le_mdc_ServiceInstanceName = "qmiAirVantage.qmiAirVantage.le_mdc";
LE_SHARED const char* _qmiAirVantage_le_data_ServiceInstanceName = "qmiAirVantage.qmiAirVantage.le_data";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t qmiAirVantage_exe_LogSession;
LE_SHARED le_log_Level_t* qmiAirVantage_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    qmiAirVantage_exe_LogSession = log_RegComponent("qmiAirVantage_exe", &qmiAirVantage_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_qmiAirVantage.so");
