...
// Startup code for the executable 'wifiClientTest'.
...
LE_SHARED const char* _wifiClientTestComponent_le_wifiClient_ServiceInstanceName = "wifiClientTest.wifiClientTestComponent.le_wifiClient";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t wifiClientTest_exe_LogSession;
LE_SHARED le_log_Level_t* wifiClientTest_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    wifiClientTest_exe_LogSession = log_RegComponent("wifiClientTest_exe", &wifiClientTest_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_wifiClientTestComponent.so");
