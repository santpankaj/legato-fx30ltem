...
// Startup code for the executable 'wifiApTest'.
...
LE_SHARED const char* _wifiApTestComponent_le_wifiAp_ServiceInstanceName = "wifiApTest.wifiApTestComponent.le_wifiAp";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t wifiApTest_exe_LogSession;
LE_SHARED le_log_Level_t* wifiApTest_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    wifiApTest_exe_LogSession = log_RegComponent("wifiApTest_exe", &wifiApTest_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_wifiApTestComponent.so");
