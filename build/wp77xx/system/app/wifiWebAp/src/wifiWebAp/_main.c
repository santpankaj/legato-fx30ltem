...
// Startup code for the executable 'wifiWebAp'.
...
LE_SHARED const char* _wifiWebApComponent_le_wifiAp_ServiceInstanceName = "wifiWebAp.wifiWebApComponent.le_wifiAp";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t wifiWebAp_exe_LogSession;
LE_SHARED le_log_Level_t* wifiWebAp_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    wifiWebAp_exe_LogSession = log_RegComponent("wifiWebAp_exe", &wifiWebAp_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_wifiWebApComponent.so");
