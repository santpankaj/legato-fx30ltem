...
static void Handle_le_mrc_SetSarBackoffState
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_mrc_SetSarBackoffState ( 
        state );
...
static void Handle_le_mrc_GetSarBackoffState
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_mrc_GetSarBackoffState ( 
        statePtr );
...
)
{
    ...
    switch (msgPtr->id)
    {
        ...
        case _MSGID_le_mrc_SetSarBackoffState : Handle_le_mrc_SetSarBackoffState(msgRef); break;
        case _MSGID_le_mrc_GetSarBackoffState : Handle_le_mrc_GetSarBackoffState(msgRef); break;
