...
#include "le_wifiClient_server.h"
...
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_wifiClient_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_wifiClient_ServerHandlers", 3);
...
static void AsyncResponse_le_wifiClient_AddNewEventHandler
(
...
static void Handle_le_wifiClient_AddNewEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    _result  = le_wifiClient_AddNewEventHandler ( AsyncResponse_le_wifiClient_AddNewEventHandler, 
        contextPtr );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_wifiClient_RemoveNewEventHandler;
...
static void Handle_le_wifiClient_RemoveNewEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    _UNLOCK
    handlerRef = (le_wifiClient_NewEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);
...
static void Handle_le_wifiClient_Start
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_wifiClient_Stop
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_wifiClient_Scan
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_wifiClient_GetFirstAccessPoint
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    _result  = le_wifiClient_GetFirstAccessPoint (  );
...
static void Handle_le_wifiClient_GetNextAccessPoint
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_wifiClient_AccessPointRef_t _result;
    _result  = le_wifiClient_GetNextAccessPoint (  );
...
static void Handle_le_wifiClient_GetSignalStrength
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    int16_t _result;
    _result  = le_wifiClient_GetSignalStrength ( 
        accessPointRef );
    ...
    // Pack the result first
    LE_ASSERT(le_pack_PackInt16( &_msgBufPtr, &_msgBufSize, _result ));
...
static void Handle_le_wifiClient_GetBssid
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    if ( (bssidSize > 18) &&
         (bssidSize < UINT32_MAX) )
    {
        LE_DEBUG("Adjusting bssidSize from %zu to 18", bssidSize);
        bssidSize = 18;
    }
    if (bssidSize >= UINT32_MAX)
    {
        bssidSize = 0;
    }
    else
    ...
    // Call the function
    le_result_t _result;
    _result  = le_wifiClient_GetBssid ( 
        accessPointRef, 
        bssid, 
        bssidSize );
...
static void Handle_le_wifiClient_GetSsid
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    if ( (ssidSize > 33) )
    {
        LE_DEBUG("Adjusting ssidSize from %zu to 33", ssidSize);
        ssidSize = 33;
    }

    // Define storage for output parameters
    uint8_t ssidBuffer[33];
    uint8_t *ssidPtr = ssidBuffer;
    size_t *ssidSizePtr = &ssidSize;
    if (!(_requiredOutputs & (1u << 0)))
    {
        ssidPtr = NULL;
    }
...
static void Handle_le_wifiClient_SetPassphrase
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_wifiClient_SetPassphrase ( 
        accessPointRef, 
        PassPhrase );
...
static void Handle_le_wifiClient_SetPreSharedKey
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_wifiClient_SetPreSharedKey ( 
        accessPointRef, 
        PreSharedKey );
...
static void Handle_le_wifiClient_SetSecurityProtocol
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_wifiClient_SetSecurityProtocol ( 
        accessPointRef, 
        securityProtocol );
...
static void Handle_le_wifiClient_SetUserCredentials
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_wifiClient_SetUserCredentials ( 
        accessPointRef, 
        userName, 
        password );
...
static void Handle_le_wifiClient_SetWepKey
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_wifiClient_SetWepKey ( 
        accessPointRef, 
        wepKey );
...
static void Handle_le_wifiClient_SetHiddenNetworkAttribute
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_wifiClient_SetHiddenNetworkAttribute ( 
        accessPointRef, 
        hidden );
...
static void Handle_le_wifiClient_Create
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_wifiClient_Delete
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_wifiClient_Connect
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_wifiClient_Disconnect
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_wifiClient_Disconnect (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_wifiClient_AddNewEventHandler : Handle_le_wifiClient_AddNewEventHandler(msgRef); break;
        case _MSGID_le_wifiClient_RemoveNewEventHandler : Handle_le_wifiClient_RemoveNewEventHandler(msgRef); break;
        case _MSGID_le_wifiClient_Start : Handle_le_wifiClient_Start(msgRef); break;
        case _MSGID_le_wifiClient_Stop : Handle_le_wifiClient_Stop(msgRef); break;
        case _MSGID_le_wifiClient_Scan : Handle_le_wifiClient_Scan(msgRef); break;
        case _MSGID_le_wifiClient_GetFirstAccessPoint : Handle_le_wifiClient_GetFirstAccessPoint(msgRef); break;
        case _MSGID_le_wifiClient_GetNextAccessPoint : Handle_le_wifiClient_GetNextAccessPoint(msgRef); break;
        case _MSGID_le_wifiClient_GetSignalStrength : Handle_le_wifiClient_GetSignalStrength(msgRef); break;
        case _MSGID_le_wifiClient_GetBssid : Handle_le_wifiClient_GetBssid(msgRef); break;
        case _MSGID_le_wifiClient_GetSsid : Handle_le_wifiClient_GetSsid(msgRef); break;
        case _MSGID_le_wifiClient_SetPassphrase : Handle_le_wifiClient_SetPassphrase(msgRef); break;
        case _MSGID_le_wifiClient_SetPreSharedKey : Handle_le_wifiClient_SetPreSharedKey(msgRef); break;
        case _MSGID_le_wifiClient_SetSecurityProtocol : Handle_le_wifiClient_SetSecurityProtocol(msgRef); break;
        case _MSGID_le_wifiClient_SetUserCredentials : Handle_le_wifiClient_SetUserCredentials(msgRef); break;
        case _MSGID_le_wifiClient_SetWepKey : Handle_le_wifiClient_SetWepKey(msgRef); break;
        case _MSGID_le_wifiClient_SetHiddenNetworkAttribute : Handle_le_wifiClient_SetHiddenNetworkAttribute(msgRef); break;
        case _MSGID_le_wifiClient_Create : Handle_le_wifiClient_Create(msgRef); break;
        case _MSGID_le_wifiClient_Delete : Handle_le_wifiClient_Delete(msgRef); break;
        case _MSGID_le_wifiClient_Connect : Handle_le_wifiClient_Connect(msgRef); break;
        case _MSGID_le_wifiClient_Disconnect : Handle_le_wifiClient_Disconnect(msgRef); break;
