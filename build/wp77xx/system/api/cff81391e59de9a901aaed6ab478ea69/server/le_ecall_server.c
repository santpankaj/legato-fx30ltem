...
static void Handle_le_ecall_SetEraGlonassPostTestRegistrationTime
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_ecall_SetEraGlonassPostTestRegistrationTime ( 
        postTestRegTime );
...
static void Handle_le_ecall_GetEraGlonassPostTestRegistrationTime
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Define storage for output parameters
    uint16_t postTestRegTimeBuffer;
    uint16_t *postTestRegTimePtr = &postTestRegTimeBuffer;
    if (!(_requiredOutputs & (1u << 0)))
    {
        postTestRegTimePtr = NULL;
    }

    // Call the function
    le_result_t _result;
    _result  = le_ecall_GetEraGlonassPostTestRegistrationTime ( 
        postTestRegTimePtr );
...
)
{
    ...
    switch (msgPtr->id)
    {
        ...
        case _MSGID_le_ecall_SetEraGlonassPostTestRegistrationTime : Handle_le_ecall_SetEraGlonassPostTestRegistrationTime(msgRef); break;
        ...
        case _MSGID_le_ecall_GetEraGlonassPostTestRegistrationTime : Handle_le_ecall_GetEraGlonassPostTestRegistrationTime(msgRef); break;
