...
)
{
    ...
    if (!le_pack_UnpackInt64( &_msgBufPtr, &_msgBufSize,
                                               &locationDataSrc ))
    {
        goto error_unpack;
    }
    ...
    {
        LE_ASSERT(le_pack_PackInt64( &_msgBufPtr, &_msgBufSize,
                                                      *locationDataDstPtr ));
    }
...
)
{
    ...
    switch (msgPtr->id)
    {
        ...
        case _MSGID_le_gnss_SetDataResolution : Handle_le_gnss_SetDataResolution(msgRef); break;
        case _MSGID_le_gnss_ConvertDataCoordinateSystem : Handle_le_gnss_ConvertDataCoordinateSystem(msgRef); break;
