...
)
{
    ...
    _UNLOCK
    handlerRef = (le_sms_RxMessageHandlerRef_t)clientDataPtr->handlerRef;
...
)
{
    ...
    le_ref_DeleteRef(_HandlerRefMap, handlerRef);
    _UNLOCK
    handlerRef = (le_sms_FullStorageEventHandlerRef_t)clientDataPtr->handlerRef;
    le_mem_Release(clientDataPtr);
    LE_ASSERT(le_pack_PackReference( &_msgBufPtr, &_msgBufSize,
                                     handlerRef ));
...
)
{
    ...
    if (tel)
    {
        LE_ASSERT(le_pack_PackSize( &_msgBufPtr, &_msgBufSize, (telSize-1) ));
    }
...
)
{
    ...
    if (timestamp)
    {
        LE_ASSERT(le_pack_PackSize( &_msgBufPtr, &_msgBufSize, (timestampSize-1) ));
    }
...
)
{
    ...
    // Unpack the result first
    if (!le_pack_UnpackSize( &_msgBufPtr, &_msgBufSize, &_result ))
    {
        goto error_unpack;
    }
...
)
{
    ...
    if (text)
    {
        LE_ASSERT(le_pack_PackSize( &_msgBufPtr, &_msgBufSize, (textSize-1) ));
    }
...
)
{
    ...
    if (binPtr)
    {
        LE_ASSERT(le_pack_PackSize( &_msgBufPtr, &_msgBufSize, (*binSizePtr) ));
    }
...
)
{
    ...
    if (ucs2Ptr)
    {
        LE_ASSERT(le_pack_PackSize( &_msgBufPtr, &_msgBufSize, (*ucs2SizePtr) ));
    }
...
)
{
    ...
    if (pduPtr)
    {
        LE_ASSERT(le_pack_PackSize( &_msgBufPtr, &_msgBufSize, (*pduSizePtr) ));
    }
...
)
{
    ...
    if (ra)
    {
        LE_ASSERT(le_pack_PackSize( &_msgBufPtr, &_msgBufSize, (raSize-1) ));
    }
...
)
{
    ...
    if (scts)
    {
        LE_ASSERT(le_pack_PackSize( &_msgBufPtr, &_msgBufSize, (sctsSize-1) ));
    }
...
)
{
    ...
    if (dt)
    {
        LE_ASSERT(le_pack_PackSize( &_msgBufPtr, &_msgBufSize, (dtSize-1) ));
    }
