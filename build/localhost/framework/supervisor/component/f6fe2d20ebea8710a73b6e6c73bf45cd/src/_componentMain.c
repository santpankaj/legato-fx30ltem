...
extern const char* _supervisor_le_kernelModule_ServiceInstanceName;
const char** le_kernelModule_ServiceInstanceNamePtr = &_supervisor_le_kernelModule_ServiceInstanceName;
void le_kernelModule_AdvertiseService(void);
...
__attribute__((constructor)) void _supervisor_Init(void)
{
    ...
    // 'le_kernelModule' is [manual-start].
