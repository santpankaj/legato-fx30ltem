...
if [ "$SERVER_PARAM" = "$SERVEROPT" ]; then
    ...
    /home/pankaj/Documents/yoctosrc_fx30LTECatM/legato-af_fx30ltem/build/localhost/framework/bin/serviceDirectory &
    sleep 1
    /home/pankaj/Documents/yoctosrc_fx30LTECatM/legato-af_fx30ltem/build/localhost/framework/bin/logCtrlDaemon &
    /home/pankaj/Documents/yoctosrc_fx30LTECatM/legato-af_fx30ltem/build/localhost/framework/bin/configTree &
fi
...
sleep 1
/home/pankaj/Documents/yoctosrc_fx30LTECatM/legato-af_fx30ltem/build/localhost/framework/bin/config set /configTest/testCount 0


# Set the configTree transaction timeout to something more manageable.
/home/pankaj/Documents/yoctosrc_fx30LTECatM/legato-af_fx30ltem/build/localhost/framework/bin/config set /configTree/transactionTimeout 5 int
...
ExecWithTimeout 10 0 /home/pankaj/Documents/yoctosrc_fx30LTECatM/legato-af_fx30ltem/build/localhost/tests/bin/configDropReadExe
ExecWithTimeout 10 0 /home/pankaj/Documents/yoctosrc_fx30LTECatM/legato-af_fx30ltem/build/localhost/tests/bin/configDropWriteExe


# Now, tell them to hang around to make sure that the automatic timeouts work.
ExecWithTimeout 10 1 /home/pankaj/Documents/yoctosrc_fx30LTECatM/legato-af_fx30ltem/build/localhost/tests/bin/configDropReadExe hangAround
ExecWithTimeout 10 1 /home/pankaj/Documents/yoctosrc_fx30LTECatM/legato-af_fx30ltem/build/localhost/tests/bin/configDropWriteExe hangAround
...
echo $MY_STR | ExecWithTimeout 60 0 xargs -n 1 -P 0 /home/pankaj/Documents/yoctosrc_fx30LTECatM/legato-af_fx30ltem/build/localhost/tests/bin/configTestExe

# Report the number of tests that were run.
echo "Number of tests run:"
/home/pankaj/Documents/yoctosrc_fx30LTECatM/legato-af_fx30ltem/build/localhost/framework/bin/config get /configTest/testCount


# Now, as a final test and to clean up after ourselves.  Delete the trees from the system.
ExecWithTimeout 10 0 /home/pankaj/Documents/yoctosrc_fx30LTECatM/legato-af_fx30ltem/build/localhost/tests/bin/configDelete
