 ...
 *
 * @note If linux system time is not updated automatically, update system date/time with either
 * Linux date command or by calling le_clk_SetAbsoluteTime() function.
 *
 * The time given to le_clk_SetAbsoluteTime() function can be retrieved by:
