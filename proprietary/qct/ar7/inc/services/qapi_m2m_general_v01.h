...
/* This file was generated with Tool version 5.1 
   It was generated on: Tue Aug 25 2015
...
#define QAPI_M2M_GENERAL_V01_IDL_MINOR_VERS 0x00
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define QAPI_M2M_GENERAL_V01_IDL_TOOL_VERS 0x05
/** Maximum Defined Message ID */
#define QAPI_M2M_GENERAL_V01_MAX_MESSAGE_ID 0x00C5;
/** 
    @} 
  */
...
/************
 *
 * Name:     gnss_bds_control
 *
 * Purpose:  Enumerates BDS constellation control.
 *
 * Members:  See below
 *
 * Notes:    none
 *
 ************/
enum gnss_bds_control
{
  GNSS_BDS_DISABLE = 0,              /* Disable Beidou */
  GNSS_BDS_WORLDWIDE,                /* Enable Beidou worldwide */
  GNSS_BDS_OUTSIDE_US,               /* Enable Beidou outside US */
  GNSS_BDS_CONTROL_MAX = GNSS_BDS_OUTSIDE_US
};

/************
 *
 * Name:     gnss_gal_control
 *
 * Purpose:  Enumerates GAL constellation control.
 *
 * Members:  See below
 *
 * Notes:    none
 *
 ************/
enum gnss_gal_control
{
  GNSS_GAL_DISABLE = 0,              /* Disable Galileo */
  GNSS_GAL_WORLDWIDE,                /* Enable Galileo worldwide */
  GNSS_GAL_OUTSIDE_US,               /* Enable Galileo outside US */
  GNSS_GAL_CONTROL_MAX = GNSS_GAL_OUTSIDE_US
};
