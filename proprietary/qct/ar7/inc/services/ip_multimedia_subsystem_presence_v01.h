#ifndef IMSP_SERVICE_01_H
#define IMSP_SERVICE_01_H
/**
...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/2.3/imsp/api/ip_multimedia_subsystem_presence_v01.h#2 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
#define IMSP_V01_IDL_MINOR_VERS 0x03
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define IMSP_V01_IDL_TOOL_VERS 0x06
...
#define IMSP_ENABLE_PUBLISH_TRIGGER_IND_V01 ((imsp_event_report_bit_masks_v01)0x01ull) 
#define IMSP_ENABLE_ENABLER_STATE_IND_V01 ((imsp_event_report_bit_masks_v01)0x02ull) 
#define IMSP_ENABLE_NOTIFY_IND_V01 ((imsp_event_report_bit_masks_v01)0x04ull) 
/** @addtogroup imsp_qmi_messages
    @{
  */
...
/** @addtogroup imsp_qmi_msg_ids
    @{
  */
#define QMI_IMSP_GET_SUPPORTED_MSGS_REQ_V01 0x001E
#define QMI_IMSP_GET_SUPPORTED_MSGS_RESP_V01 0x001E
#define QMI_IMSP_GET_SUPPORTED_FIELDS_REQ_V01 0x001F
#define QMI_IMSP_GET_SUPPORTED_FIELDS_RESP_V01 0x001F
