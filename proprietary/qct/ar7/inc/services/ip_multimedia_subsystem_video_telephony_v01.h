#ifndef IMSVT_SERVICE_01_H
#define IMSVT_SERVICE_01_H
/**
...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/2.3/imsvt/api/ip_multimedia_subsystem_video_telephony_v01.h#2 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
#define IMSVT_V01_IDL_MINOR_VERS 0x03
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define IMSVT_V01_IDL_TOOL_VERS 0x06
...
/** @addtogroup imsvt_qmi_messages
    @{
  */
/** Acknowledgement Message; Queries the fields supported for a single command as implemented 
...
/** @addtogroup imsvt_qmi_msg_ids
    @{
  */
#define QMI_IMSVT_GET_SUPPORTED_MSGS_REQ_V01 0x001E
#define QMI_IMSVT_GET_SUPPORTED_MSGS_RESP_V01 0x001E
#define QMI_IMSVT_GET_SUPPORTED_FIELDS_REQ_V01 0x001F
#define QMI_IMSVT_GET_SUPPORTED_FIELDS_RESP_V01 0x001F
