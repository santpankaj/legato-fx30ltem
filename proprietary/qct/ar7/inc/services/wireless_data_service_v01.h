...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/2.3/wds/api/wireless_data_service_v01.h#25 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
/* This file was generated with Tool version 6.5 
   It was generated on: Sat Sep 21 2013 (Spin 1)
...
#define WDS_V01_IDL_MINOR_VERS 0x35
...
/* SWISTART */
#ifdef SIERRA
#define QMI_WDS_APN_NAME_SIZE_V01 100
#define QMI_WDS_IPV6_ADDR_SIZE_V01 2
#define QMI_WDS_IPV6_GATEWAY_ADDR_SIZE_V01 2
#define QMI_WDS_IPV6_DNS_ADDR_PRI_SIZE_V01 2
#define QMI_WDS_IPV6_DNS_ADDR_SEC_SIZE_V01 2
#define QMI_WDS_IPV6_PCSCF_ADDR_PRI_SIZE_V01 2
#define QMI_WDS_IPV6_PCSCF_ADDR_SEC_SIZE_V01 2
#define QMI_WDS_OTA_APN_SIZE_V01 100

#define QMI_WDS_ADDRESS_SIZE_V01 20
#endif /* SIERRA */
/* SWISTOP */
...
typedef struct {
  ...
  */
  ...
  uint8_t disallow_timer_valid;  /**< Must be set to true if disallow_timer is being passed */
  uint32_t disallow_timer[QMI_WDS_MAX_DISALLOW_TIMER_V01];
  /**<   The backoff time, in seconds, to be used after the network refuses 
  to grant the requested IP address type, such as when an IPv6 address is requested 
  from a network that only grants the IPv4 address. For example, immediately 
  after a third consecutive PDN connection request is denied, the UE waits 
  disallow_timer[2] seconds before sending the fourth request. 
...
typedef struct {
  ...
  */
  ...
  uint8_t failure_timer_valid;  /**< Must be set to true if failure_timer is being passed */
  uint32_t failure_timer[QMI_WDS_MAX_FAILURE_TIMER_V01];
  /**<   The backoff time (in seconds) to be used after a PDN connection or 
  IP address assignment failure. For example, immediately following a third 
  consecutive PDN connection request failure, the UE waits failure_timer[2] 
...
#define QMI_WDS_MASK_EVT_EXT_IPCONFIG_V01 ((wds_evt_reg_mask_v01)0x02) /**<  Extended IP Configuration \n  */
...
#define QMI_WDS_MASK_EVT_HDR_SM_SUCCESS_V01 ((wds_evt_reg_mask_v01)0x10) /**<  HDR Set EIDLE Slotted Mode Success \n  */
#define QMI_WDS_MASK_EVT_HDR_SM_FAILURE_V01 ((wds_evt_reg_mask_v01)0x20) /**<  HDR Set EIDLE Slotted Mode Failure \n  */
#define QMI_WDS_MASK_EVT_HDR_SM_SESS_CHANGE_V01 ((wds_evt_reg_mask_v01)0x40) /**<  HDR Set EIDLE Slotted Mode Session Changed \n  */
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Request Message; Allows the control point to register for IFACE events.  */
typedef struct {

  /* Mandatory */
  /*  Event Registration Mask */
  wds_evt_reg_mask_v01 event_registration_mask;
  /**<   Requested event bit mask. Values: \n
      - QMI_WDS_MASK_EVT_OUTAGE_NOTIFICATION (0x01) --  Outage Notification \n 
      - QMI_WDS_MASK_EVT_EXT_IPCONFIG (0x02) --  Extended IP Configuration \n 
      ...
      - QMI_WDS_MASK_EVT_HDR_SM_SUCCESS (0x10) --  HDR Set EIDLE Slotted Mode Success \n 
      - QMI_WDS_MASK_EVT_HDR_SM_FAILURE (0x20) --  HDR Set EIDLE Slotted Mode Failure \n 
      - QMI_WDS_MASK_EVT_HDR_SM_SESS_CHANGE (0x40) --  HDR Set EIDLE Slotted Mode Session Changed \n 
      - QMI_WDS_MASK_EVT_RF_CONDITIONS (0x80) --  RF Conditions Change \n 
      - QMI_WDS_MASK_EVT_DOS_ACK (0x100) --  DOS ACK Event \n 

 Each bit set will cause the corresponding optional TLV to be sent in 
 the QMI_WDS_INTERNAL_IFACE_EV_IND. All unlisted bits are reserved for 
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Response Message; Allows the control point to register for IFACE events.  */
typedef struct {
...
typedef enum {
  ...
  WDS_IFACE_EVENT_EXT_IPCONFIG_V01 = 0x0002, /**<  Extended IP Configuration \n  */
  ...
  WDS_IFACE_EVENT_HDR_SM_SUCCESS_V01 = 0x0005, /**<  HDR Set EIDLE Slotted Mode Success \n  */
  WDS_IFACE_EVENT_HDR_SM_FAILURE_V01 = 0x0006, /**<  HDR Set EIDLE Slotted Mode Failure \n  */
  WDS_IFACE_EVENT_HDR_SM_SESS_CHANGE_V01 = 0x0007, /**<  HDR Set EIDLE Slotted Mode Session Changed \n  */
...
typedef enum {
  ...
  WDS_HDR_REV0_RATE_INERTIA_REQUEST_REJECTED_V01 = 0, /**<  FAIL REQUEST_REJECTED \n  */
  WDS_HDR_REV0_RATE_INERTIA_REQUEST_FAILED_TX_V01 = 1, /**<  FAIL REQUEST_FAILED_TX \n  */
  WDS_HDR_REV0_RATE_INERTIA_NOT_SUPPORTED_V01 = 2, /**<  FAIL NOT_SUPPORTED \n  */
  WDS_HDR_REV0_RATE_INERTIA_NO_NET_V01 = 3, /**<  FAIL NO_NET \n  */
...
typedef enum {
  ...
  WDS_HDR_SLOTTED_MODE_REQUEST_REJECTED_V01 = 0, /**<  FAIL REQUEST_REJECTED \n  */
  WDS_HDR_SLOTTED_MODE_REQUEST_FAILED_TX_V01 = 1, /**<  FAIL REQUEST_FAILED_TX \n  */
  WDS_HDR_SLOTTED_MODE_NOT_SUPPORTED_V01 = 2, /**<  FAIL NOT_SUPPORTED \n  */
  WDS_HDR_SLOTTED_MODE_NO_NET_V01 = 3, /**<  FAIL NO_NET \n  */
...
typedef enum {
  ...
  WDS_RF_CONDITIONS_DONT_CARE_V01 = 3, /**<  DONT_CARE \n  */
...
typedef enum {
  ...
  WDS_DOS_ACK_HOLD_ORIG_RETRY_TIMEOUT_V01 = 0x00000001, /**<  Hold orig retry timeout \n  */
  WDS_DOS_ACK_HOLD_ORIG_V01 = 0x00000002, /**<  Cannot proceed because hold orig is true \n  */
  ...
  WDS_DOS_ACK_NOT_ALLOWED_IN_HDR_V01 = 0x00000006, /**<  Cannot send in HDR call \n  */
  WDS_DOS_ACK_L2_ACK_FAILURE_V01 = 0x00000007, /**<  Failure receiving L2 ack \n  */
  WDS_DOS_ACK_OUT_OF_RESOURCES_V01 = 0x00000008, /**<  Out of resources, eg. memory buffer \n  */
  WDS_DOS_ACK_ACCESS_TOO_LARGE_V01 = 0x00000009, /**<  Message too large to be sent over acc \n  */
  WDS_DOS_ACK_DTC_TOO_LARGE_V01 = 0x0000000A, /**<  Message too large to be sent over DTC \n  */
  WDS_DOS_ACK_OTHER_V01 = 0x0000000B, /**<  Any status response other than above \n  */
  WDS_DOS_ACK_ACCT_BLOCK_V01 = 0x0000000C, /**<  Access blocked based on service option \n  */
  WDS_DOS_ACK_L3_ACK_FAILURE_V01 = 0x0000000D, /**<  Failure receiving L3 ack \n  */
...
typedef struct {
  ...
  /**<   Milliseconds in which HDR outage will start
  */

  uint32_t duration;
  /**<   Milliseconds for which HDR outage will last
  */
 ...
 */
  ...
  */
  ...
  /**<   Values: \n
      ...
      - WDS_RF_CONDITIONS_DONT_CARE (3) --  DONT_CARE \n 
 */
...
typedef struct {
  ...
  */
  ...
  uint32_t overflow;
  /**<   Set to a nonzero value, if the number of outstanding SDB/DOS packets 
       (the packets for which mobile is still waiting for an ACK) is more than 
  ...
  */
  ...
  /**<   DOS ACK status. Values: \n
      ...
      - WDS_DOS_ACK_HOLD_ORIG_RETRY_TIMEOUT (0x00000001) --  Hold orig retry timeout \n 
      - WDS_DOS_ACK_HOLD_ORIG (0x00000002) --  Cannot proceed because hold orig is true \n 
      ...
      - WDS_DOS_ACK_NOT_ALLOWED_IN_HDR (0x00000006) --  Cannot send in HDR call \n 
      - WDS_DOS_ACK_L2_ACK_FAILURE (0x00000007) --  Failure receiving L2 ack \n 
      - WDS_DOS_ACK_OUT_OF_RESOURCES (0x00000008) --  Out of resources, eg. memory buffer \n 
      - WDS_DOS_ACK_ACCESS_TOO_LARGE (0x00000009) --  Message too large to be sent over acc \n 
      - WDS_DOS_ACK_DTC_TOO_LARGE (0x0000000A) --  Message too large to be sent over DTC \n 
      - WDS_DOS_ACK_OTHER (0x0000000B) --  Any status response other than above \n 
      - WDS_DOS_ACK_ACCT_BLOCK (0x0000000C) --  Access blocked based on service option \n 
      - WDS_DOS_ACK_L3_ACK_FAILURE (0x0000000D) --  Failure receiving L3 ack \n 
 */
...
typedef struct {
  ...
  /**<   Values: \n
      ...
      - WDS_IFACE_EVENT_EXT_IPCONFIG (0x0002) --  Extended IP Configuration \n 
      ...
      - WDS_IFACE_EVENT_HDR_SM_SUCCESS (0x0005) --  HDR Set EIDLE Slotted Mode Success \n 
      - WDS_IFACE_EVENT_HDR_SM_FAILURE (0x0006) --  HDR Set EIDLE Slotted Mode Failure \n 
      - WDS_IFACE_EVENT_HDR_SM_SESS_CHANGE (0x0007) --  HDR Set EIDLE Slotted Mode Session Changed \n 
 ...
 */
  ...
  */
  ...
  /* Optional */
  /*  HDR Rev0 Rate Intertia Failure Code */
  ...
  /**<   Values: \n
      - WDS_HDR_REV0_RATE_INERTIA_REQUEST_REJECTED (0) --  FAIL REQUEST_REJECTED \n 
      - WDS_HDR_REV0_RATE_INERTIA_REQUEST_FAILED_TX (1) --  FAIL REQUEST_FAILED_TX \n 
      - WDS_HDR_REV0_RATE_INERTIA_NOT_SUPPORTED (2) --  FAIL NOT_SUPPORTED \n 
      - WDS_HDR_REV0_RATE_INERTIA_NO_NET (3) --  FAIL NO_NET \n 
 */
  ...
  /**<   Values: \n
      - WDS_HDR_SLOTTED_MODE_REQUEST_REJECTED (0) --  FAIL REQUEST_REJECTED \n 
      - WDS_HDR_SLOTTED_MODE_REQUEST_FAILED_TX (1) --  FAIL REQUEST_FAILED_TX \n 
      - WDS_HDR_SLOTTED_MODE_NOT_SUPPORTED (2) --  FAIL NOT_SUPPORTED \n 
      - WDS_HDR_SLOTTED_MODE_NO_NET (3) --  FAIL NO_NET \n 
 */
...
#define QMI_WDS_MASK_REQ_OPER_HDR_1X_HANDDOWN_OPT_V01 ((wds_req_oper_mask_v01)0x08) /**<  HDR-1x handdown option \n  */
...
typedef enum {
  ...
  WDS_SESSION_TIMER_DO_V01 = 0x01, /**<  SESSION_TIMER_DO \n  */
  WDS_SESSION_TIMER_1X_V01 = 0x02, /**<  SESSION_TIMER_1X \n  */
  WDS_SESSION_TIMER_1X_AND_DO_V01 = 0x03, /**<  SESSION_TIMER_1X_AND_DO \n  */
...
#define QMI_WDS_MASK_SDB_FLAGS_MSG_EXPEDITE_V01 ((wds_sdb_flags_mask_v01)0x01) /**<  MSG_EXPEDITE \n  */
#define QMI_WDS_MASK_SDB_FLAGS_MSG_FAST_EXPEDITE_V01 ((wds_sdb_flags_mask_v01)0x02) /**<  MSG_FAST_EXPEDITE \n  */
/** @addtogroup wds_qmi_messages
    @{
  */
/** Request Message; This allows the control point to get internal packet data session 
...
typedef struct {
  ...
  /**<   Requested internal settings bit mask. Values: \n
      ...
      - QMI_WDS_MASK_REQ_OPER_HDR_1X_HANDDOWN_OPT (0x08) --  HDR-1x handdown option \n 
 ...
 Each bit set will cause the corresponding optional TLV to be sent in 
 the QMI_WDS_GET_INTERNAL_RUNTIME_SETTINGS_RESP. All unlisted bits are 
 ...
 */
  ...
  /**<   Values: \n
      - WDS_SESSION_TIMER_DO (0x01) --  SESSION_TIMER_DO \n 
      - WDS_SESSION_TIMER_1X (0x02) --  SESSION_TIMER_1X \n 
      - WDS_SESSION_TIMER_1X_AND_DO (0x03) --  SESSION_TIMER_1X_AND_DO \n 
 */
  ...
  /**<   Requested SDB flags bit mask. Values: \n
      - QMI_WDS_MASK_SDB_FLAGS_MSG_EXPEDITE (0x01) --  MSG_EXPEDITE \n 
      - QMI_WDS_MASK_SDB_FLAGS_MSG_FAST_EXPEDITE (0x02) --  MSG_FAST_EXPEDITE \n 
 */
...
typedef struct {
  ...
  */
  ...
  int16_t error_value;
  /**<   Error obtained from the operation. Data Services error value returned by 
       the lower layers. Refer to the DS Error numbers published in 80-V6415-1 
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Response Message; This allows the control point to get internal packet data session 
           settings currently in use.  */
typedef struct {
  ...
  */
  ...
  /**<   This TLV is deprecated. Control points should use QMI_WDS_GET_EVDO_PAGE_MONITOR_PERIOD
       instead.
  */
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Request Message; This allows the control point to set / modify some internal packet 
...
typedef struct {
  ...
  */
  ...
  /**<   Slot cycle value. This TLV is deprecated. Control points should use 
       QMI_WDS_SET_EVDO_PAGE_MONITOR_PERIOD instead.
  */
  ...
  */
  ...
  /**<   Enable HDR Rev0 Inertia. Values: \n
       - 0x00 -- Disable / False \n
       - 0x01 -- Enable / True
  */
...
typedef struct {
  ...
  uint8_t tlv_type;
  /**<   TLV type in request that elicited the error
  */
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Response Message; This allows the control point to set / modify some internal packet 
           data session settings.  */
typedef struct {
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Response Message; This allows the control point to refresh DHCP configuration 
           information.  */
typedef struct {
...
/* SWISTART */
#ifdef SIERRA
/** @addtogroup sierra_swi_wds_api_qmi_aggregates
    @{
  */
typedef struct {
  ...
  uint8_t Profile_index;
  /**<  
    1-16 valid for 3GPP profile type
    101-106 valid for 3GPP2
   */
}profile_type_v01;  /* Type */
/**
    @}
  */

/** @addtogroup sierra_swi_wds_api_qmi_messages
    @{
  */
/** Request Message; This message creates configured profile with specified settings.  This message should be used instead of QMI_WDS_CREATE_PROFILE to create 3GPP2 profile and/or when specific profile index is desired to get populated. */
typedef struct {

  /* Mandatory */
  /*  profile */
  profile_type_v01 profile;
}wds_swi_create_profile_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup sierra_swi_wds_api_qmi_messages
    @{
  */
/** Response Message; This message creates configured profile with specified settings.  This message should be used instead of QMI_WDS_CREATE_PROFILE to create 3GPP2 profile and/or when specific profile index is desired to get populated. */
typedef struct {
  ...
  /*  Result Code */
  qmi_response_type_v01 resp;
}wds_swi_create_profile_resp_msg_v01;  /* Message */
...
/** @addtogroup sierra_swi_wds_api_qmi_messages
    @{
  */
/** Request Message; This message requests the device to return the active PDP context associated with a context id. */
typedef struct {
  ...
  /**<  
    Context Id
    Valid ID for 3GPP technology is 1 每 16.
    Valid ID for 3GPP2 technology is 101 每 107.
   */
  ...
  /**<  
    ...
    1 每 3GPP2
   */
}wds_swi_pdp_runtime_settings_req_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  uint64_t ipv6_addr[QMI_WDS_IPV6_ADDR_SIZE_V01];
  /**<  
    IPv6 address (in network byte
    order); this is an 8-element array of 16-bit numbers, each of which is in big-endian format
   */

  uint8_t ipv6_prefix_length;
  /**<  
    IPV6 prefix length in number of bits; can take a value between 0 and 128
   */
}ipv6_addr_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint64_t ipv6_gateway_addr[QMI_WDS_IPV6_GATEWAY_ADDR_SIZE_V01];
  /**<  
  ...
  uint8_t ipv6_prefix_length;
  /**<  
    IPV6 prefix length in number of bits; can
    take a value between 0 and 128
   */
}ipv6_gateway_addr_type_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup sierra_swi_wds_api_qmi_messages
    @{
  */
/** Response Message; This message requests the device to return the active PDP context associated with a context id. */
typedef struct {
  ...
  /* Optional */
  /*  Context_id */
  uint8_t Context_id_valid;  /**< Must be set to true if Context_id is being passed */
  uint8_t Context_id;
  /**<  
    Context Id
   */
  ...
  /*  apn_name */
  uint8_t apn_name_valid;  /**< Must be set to true if apn_name is being passed */
  char apn_name[QMI_WDS_APN_NAME_SIZE_V01 + 1];
  /**<  
  ...
  /* Optional */
  /*  ipv4_dns_addr_pri */
  uint8_t ipv4_dns_addr_pri_valid;  /**< Must be set to true if ipv4_dns_addr_pri is being passed */
  uint32_t ipv4_dns_addr_pri;
  /**<  
    Primary DNS IPv4 Address
   */
  ...
  /* Optional */
  /*  ipv4_dns_addr_sec */
  uint8_t ipv4_dns_addr_sec_valid;  /**< Must be set to true if ipv4_dns_addr_sec is being passed */
  uint32_t ipv4_dns_addr_sec;
  /**<  
    Secondary DNS IPv4 Address
   */
  ...
  /*  ipv6_addr */
  uint8_t ipv6_addr_valid;  /**< Must be set to true if ipv6_addr is being passed */
  ipv6_addr_type_v01 ipv6_addr;

  /* Optional */
  /*  ipv6_gateway_addr */
  uint8_t ipv6_gateway_addr_valid;  /**< Must be set to true if ipv6_gateway_addr is being passed */
  ipv6_gateway_addr_type_v01 ipv6_gateway_addr;

  /* Optional */
  /*  ipv6_dns_addr_pri */
  uint8_t ipv6_dns_addr_pri_valid;  /**< Must be set to true if ipv6_dns_addr_pri is being passed */
  uint64_t ipv6_dns_addr_pri[QMI_WDS_IPV6_DNS_ADDR_PRI_SIZE_V01];
  /**<  
    Primary IPv6 DNS address (in network byte order); this is an 8-element array of 16-bit
    numbers, each of which is in big-endian format
   */

  /* Optional */
  /*  ipv6_dns_addr_sec */
  uint8_t ipv6_dns_addr_sec_valid;  /**< Must be set to true if ipv6_dns_addr_sec is being passed */
  uint64_t ipv6_dns_addr_sec[QMI_WDS_IPV6_DNS_ADDR_SEC_SIZE_V01];
  /**<  
    Secondary IPv6 DNS address (in network byte order); this is an 8-element array of 16-bit
    numbers, each of which is in big-endian
    format
   */
  ...
  /* Optional */
  /*  Ipv4_pcscf_addr_pri */
  uint8_t Ipv4_pcscf_addr_pri_valid;  /**< Must be set to true if Ipv4_pcscf_addr_pri is being passed */
  uint32_t Ipv4_pcscf_addr_pri;
  /**<  
  ...
  /* Optional */
  /*  Ipv4_pcscf_addr_sec */
  uint8_t Ipv4_pcscf_addr_sec_valid;  /**< Must be set to true if Ipv4_pcscf_addr_sec is being passed */
  uint32_t Ipv4_pcscf_addr_sec;
  /**<  
  ...
  /* Optional */
  /*  ipv6_pcscf_addr_pri */
  uint8_t ipv6_pcscf_addr_pri_valid;  /**< Must be set to true if ipv6_pcscf_addr_pri is being passed */
  uint64_t ipv6_pcscf_addr_pri[QMI_WDS_IPV6_PCSCF_ADDR_PRI_SIZE_V01];
  /**<  
  ...
  /* Optional */
  /*  ipv6_pcscf_addr_sec */
  uint8_t ipv6_pcscf_addr_sec_valid;  /**< Must be set to true if ipv6_pcscf_addr_sec is being passed */
  uint64_t ipv6_pcscf_addr_sec[QMI_WDS_IPV6_PCSCF_ADDR_SEC_SIZE_V01];
  /**<  
  ...
  /* Optional */
  /*  OTA_APN */
  uint8_t OTA_APN_valid;  /**< Must be set to true if OTA_APN is being passed */
  char OTA_APN[QMI_WDS_OTA_APN_SIZE_V01 + 1];
  /**<  
    NULL terminated ASCII string representing fully qualified APN (NI+OI) as returned by the network.
   */
}wds_swi_pdp_runtime_settings_resp_msg_v01;  /* Message */
/**
    @}
  */
/** @addtogroup sierra_swi_wds_api_qmi_messages
    @{
  */
/** Request Message; This message is used to set MTPDP ring indicator enable/disable to report to control point. */
typedef struct {

  /* Mandatory */
  /*  ring_indicator */
  uint8_t ring_indicator;
  /**<  
    0 - disabled
    1 每 enabled
   */
}wds_swi_set_mtpdp_ring_report_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup sierra_swi_wds_api_qmi_messages
    @{
  */
/** Response Message; This message is used to set MTPDP ring indicator enable/disable to report to control point. */
typedef struct {

  /* Mandatory */
  /*  Result Code */
  qmi_response_type_v01 resp;
}wds_swi_set_mtpdp_ring_report_resp_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  uint16_t apn_len;
  /**<  
    Length of the APN str
   */

  uint8_t apn_name[QMI_WDS_APN_NAME_SIZE_V01+1];
  /**<  
    Store the APN
   */
}apn_type_v01;  /* Type */
...
typedef struct {
  ...
  uint8_t address[QMI_WDS_ADDRESS_SIZE_V01];
  /**<  
    PDP address
   */
}pdp_addr_type_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup sierra_swi_wds_api_qmi_messages
    @{
  */
/** Indication Message; This message is used to set MTPDP ring indicator enable/disable to report to control point. */
typedef struct {
  ...
  uint8_t profile_id;
  /**<  
    Profile number to be used for MO call
   */
  ...
  /* Mandatory */
  /*  pdp_addr */
  pdp_addr_type_v01 pdp_addr;
}wds_swi_set_mtpdp_ring_report_ind_msg_v01;  /* Message */
/**
    @}
  */

/*
 * wds_swi_reject_mtpdp_call_req_msg is empty
 * typedef struct {
 * }wds_swi_reject_mtpdp_call_req_msg_v01;
 */

/** @addtogroup sierra_swi_wds_api_qmi_messages
    @{
  */
/** Response Message; This message is used to reject an MTPDP IP type call. */
typedef struct {

  /* Mandatory */
  /*  Result Code */
  qmi_response_type_v01 resp;
}wds_swi_reject_mtpdp_call_resp_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  /**<  
    Profile Family
   */
}default_profile_req_type_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Request Message; This QMI interface is used to extern the QCT QMI interface QMI_WDS_GET_DEFAULT_PROFILE_NUM. It is used to get the default profile number based on the profile type and profile family. */
typedef struct {

  /* Mandatory */
  /*  default_profile_req */
  default_profile_req_type_v01 default_profile_req;
}wds_swi_get_default_profile_num_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Response Message; This QMI interface is used to extern the QCT QMI interface QMI_WDS_GET_DEFAULT_PROFILE_NUM. It is used to get the default profile number based on the profile type and profile family. */
typedef struct {

  /* Mandatory */
  /*  default_profile_resp */
  uint8_t default_profile_resp;
  /**<  
    Profile Index
   */
  ...
  /**<  
    Extended error code
   */
}wds_swi_get_default_profile_num_resp_msg_v01;  /* Message */
/**
    @}
  */
#endif /* SIERRA */
...
/* SWISTART */
#ifdef SIERRA
#define QMI_WDS_SWI_CREATE_PROFILE_REQ_V01 0x5558
#define QMI_WDS_SWI_CREATE_PROFILE_RESP_V01 0x5558
#define QMI_WDS_SWI_PDP_RUNTIME_SETTINGS_REQ_V01 0x555B
#define QMI_WDS_SWI_PDP_RUNTIME_SETTINGS_RESP_V01 0x555B
#define QMI_WDS_SWI_SET_MTPDP_RING_REPORT_REQ_V01 0x556C
#define QMI_WDS_SWI_SET_MTPDP_RING_REPORT_RESP_V01 0x556C
#define QMI_WDS_SWI_SET_MTPDP_RING_REPORT_IND_V01 0x556C
#define QMI_WDS_SWI_REJECT_MTPDP_CALL_REQ_V01 0x556D
#define QMI_WDS_SWI_REJECT_MTPDP_CALL_RESP_V01 0x556D
#define QMI_WDS_SWI_GET_DEFAULT_PROFILE_NUM_REQ_V01 0x556E
#define QMI_WDS_SWI_GET_DEFAULT_PROFILE_NUM_RESP_V01 0x556E
#endif /* SIERRA */
/* SWISTOP */
