...
#define SWILOC_V01_IDL_MINOR_VERS 0x01
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define SWILOC_V01_IDL_TOOL_VERS 0x05
/** Maximum Defined Message ID */
#define SWILOC_V01_MAX_MESSAGE_ID 0x0005;
/**
    @}
  */
...
/** @addtogroup swiloc_qmi_aggregates
    @{
  */
typedef struct {
  ...
  /**<
    Units: Meters
   */
}swiloc_multi_position_info_src_type_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup swiloc_qmi_messages
    @{
  */
/** Request Message; This command is used to output the transferred position information in multi-coordinate system from WGS84. Now only PZ90 is supported. */
typedef struct {

  /* Mandatory */
  /*  coordinate_type_src */
  uint8_t coordinate_type_src;
  /**<
    Coordinate system to be transferred:
    0 - WGS84
    1 - PZ90
    2 - OTHERS
   */
  ...
  /* Mandatory */
  /*  position_info_src */
  swiloc_multi_position_info_src_type_v01 position_info_src;

  /* Mandatory */
  /*  coordinate_type_dst */
  uint8_t coordinate_type_dst;
  /**<
    Coordinate system transferred
    0 - WGS84
    1 - PZ90
    2 - OTHERS
   */
}swiloc_multi_coordinate_position_info_req_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  /**<
    Units: Meters
   */
}swiloc_multi_position_info_dst_type_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup swiloc_qmi_messages
    @{
  */
/** Response Message; This command is used to output the transferred position information in multi-coordinate system from WGS84. Now only PZ90 is supported. */
typedef struct {
  ...
  /* Mandatory */
  /*  position_info_dst */
  swiloc_multi_position_info_dst_type_v01 position_info_dst;
}swiloc_multi_coordinate_position_info_resp_msg_v01;  /* Message */
/**
    @}
  */
...
#define QMI_SWILOC_MULTI_COORDINATE_POSITION_INFO_REQ_V01 0x0005
#define QMI_SWILOC_MULTI_COORDINATE_POSITION_INFO_RESP_V01 0x0005
/**
    @}
  */
