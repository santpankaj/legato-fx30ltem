...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //Commercial/MPSS.DPM.2.0.2.c1/Main/modem_proc/qmimsgs/imsa/api/ip_multimedia_subsystem_application_v01.h#4 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.7
   It was generated on: Thu Dec 17 2015 (Spin 0)
...
#define IMSA_V01_IDL_MINOR_VERS 0x16
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define IMSA_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define IMSA_V01_MAX_MESSAGE_ID 0x0032
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  VoWIFI Qualitiy Status Configuration */
...
/** @addtogroup imsa_qmi_messages
    @{
  */
/** Request Message; Sets the Civic Address */
typedef struct {
...
/** @addtogroup imsa_qmi_messages
    @{
  */
/** Response Message; Sets the Civic Address */
typedef struct {
...
/** @addtogroup imsa_qmi_messages
    @{
  */
/** Indication Message; Indication sent with Lat/Long  */
typedef struct {
...
/** @addtogroup imsa_qmi_messages
    @{
  */
/** Indication Message; Indication sent with the VoWIFI changes.  */
typedef struct {

  /* Mandatory */
  /*  IMS VoWIFI Qualitiy Status */
  imsa_vowifiprofile_status_enum_v01 vowifiprofile_status;
