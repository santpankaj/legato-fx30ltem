...
/*
 * dms_get_firmware_pref_req_msg is empty
 * typedef struct {
...
typedef struct {
  ...
  uint8_t num_entries;
  /**<
    Number of entries in the following list of image preferences. An entry consists of the following parameters: image_type, unique_id, build_id_len, and build_id. If no entries are found, this field will be set to 0 and no data will follow.
   */

  image_preference_entry_type_v01 image_preference_entries[QMI_DMS_NUM_SUPPORTED_IMAGE_TYPES_V01];
}image_preference_list_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  image_preference_list_type_v01 image_preference_list;
...
typedef struct {
  ...
  uint8_t num_entries;
  /**<
    Number of entries in the following list of image types that are not present in the device’s storage and must be downloaded
   */
...
/*
 * dms_list_stored_images_req_msg is empty
 * typedef struct {
...
typedef struct {
  ...
  uint8_t sublist_len;
  /**<
    Number of entries included in the following sub-list. A sub-list entry consists of the following parameters: storage_index, failure_count, unique_id, build_id_len, and build_id.
   */
...
typedef struct {
  ...
  uint8_t num_types;
  /**<
    Number of list entries containing information about a specific image type present in the device storage. A list entry contains the following parameters: image_type, max_images, running_image and sublist_len; and one or more sub-list entries with the following parameters: storage_index, unique_id, build_id_len, and build_id.
   */

  stored_image_entry_type_v01 stored_image_entries[QMI_DMS_NUM_SUPPORTED_IMAGE_TYPES_V01];
}stored_image_list_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  /* Mandatory */
  /*  stored_image_list */
  stored_image_list_type_v01 stored_image_list;
...
/*
 * dms_swi_get_stored_images_req_msg is empty
 * typedef struct {
...
typedef struct {
  ...
  uint8_t sublist_len;
  /**<
    Number of entries included in the following sub-list. A sub-list entry consists of the following parameters: storage_index, failure_count, unique_id, build_id_len, build_id and sierra fields.
   */
...
typedef struct {
  ...
  uint8_t num_types;
  /**<
    Number of list entries containing information about a specific image type present in the device storage. A list entry contains the following parameters: image_type, max_images, running_image and sublist_len; and one or more sub-list entries.
   */

  stored_image_swi_entry_type_v01 stored_image_swi_entries[QMI_DMS_NUM_SUPPORTED_IMAGE_TYPES_V01];
}stored_image_swi_list_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  stored_image_swi_list_type_v01 stored_image_swi_list;
