...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/2.3/nas/api/network_access_service_v01.h#19 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
/* This file was generated with Tool version 6.14.5 
   It was generated on: Thu Jun 11 2015 (Spin 0)
...
#define NAS_V01_IDL_MINOR_VERS 0x8F
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define NAS_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define NAS_V01_MAX_MESSAGE_ID 0x00AE
/**
    @}
  */
...
#define E_UTRA_OPERATING_BAND_21_V01 ((lte_band_pref_mask_type_v01)0x000000000100000ull) /**<  Bit  21 -- E-UTRA Operating Band 21 \n  */
...
#define E_UTRA_OPERATING_BAND_32_V01 ((lte_band_pref_mask_type_v01)0x000000020000000ull) /**<  Bit  32 -- E-UTRA Operating Band 32 \n  */
...
typedef struct {
  ...
  uint64_t bits_1_64;
  /**<   [1-64] bits of the 256 bit LTE E-UTRA Operating Band bitmask*/

  uint64_t bits_65_128;
  /**<   [65-128] bits of the 256 bit LTE E-UTRA Operating Band bitmask*/

  uint64_t bits_129_192;
  /**<   [129-192] bits of the 256 bit LTE E-UTRA Operating Band bitmask*/

  uint64_t bits_193_256;
  /**<   [193-256] bits of the 256 bit LTE E-UTRA Operating Band bitmask*/
 ...
 */
  ...
  uint8_t force;
  /**<    When TRUE, indicates that in the event that \n
       UE cannot process the request due to \n
       LPM transition, lower layer is busy, etc. \n
       the request will be buffered and processed  \n
       as soon as possible instead of returning \n
...
typedef struct {
  ...
  */
  ...
  /*  Nmr_c1 */
  int32_t nmr_c1;
  /**<   C1 as defined in \hyperref[S13]{[S13]} Section 6.4. Default: 0.
  */

  /*  Nmr_c2 */
  int32_t nmr_c2;
  /**<   C2 as defined in \hyperref[S13]{[S13]} Section 6.4. Default: 0.
  */

  /*  Nmr_c31 */
  int32_t nmr_c31;
  /**<   C31 as defined in \hyperref[S13]{[S13]} Section 10.1.2. Default: 0.
  */

  /*  Nmr_c32 */
  int32_t nmr_c32;
  /**<   C32 as defined in \hyperref[S13]{[S13]} Section 10.1.2. Default: 0.
  */
...
typedef enum {
  ...
  NAS_DDS_DURATION_PERMANANT_V01 = 0x00, 
  NAS_DDS_DURATION_TEMPORARY_V01 = 0x01, 
 ...
 */
  ...
  */
  ...
  /**<   Indicates the duration of a DDS switch. Values: \n
      - NAS_DDS_DURATION_PERMANANT (0x00) -- 
      - NAS_DDS_DURATION_TEMPORARY (0x01) -- 
...
typedef struct {
  ...
  /**<   Bitmasks included in this TLV limit the reporting of QMI_NAS_SYS_INFO_IND 
       ...
       - 0x100000000 -- NAS_LIMIT_BY_WCDMA_ EUTRA_STATUS -- Limit by WCDMA_EUTRA_ status \n
...
typedef struct {
  ...
  */
  ...
  /**<   List of the user-configured LTE bands, ordered by priority. The ordering 
       ...
       - 120 to 160 -- LTE band classes (see Table @latexonly\ref{tbl:bandClass}@endlatexonly for details)
  */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; Retrieves the network negotiated DRX(Discontinuous reception) level. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of 
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Response Message; Retrieves the network negotiated DRX(Discontinuous reception) level. */
typedef struct {
...
typedef struct {
  ...
  /**<   Access barring factor for voice calls. Range: 0 to 100.
       Value 100 indicates Invalid. All values are per \hyperref[S21]{[S21]}.
  */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; This API is used to set the SSAC hysteresis timer, when UE moves from non-Voice Area to Voice Area, 
	       the device shall start a hysteresis timer and domain selection will not notify IMS about voice preference until the expiry of hysteresis timer. */
typedef struct {
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Response Message; This API is used to set the SSAC hysteresis timer, when UE moves from non-Voice Area to Voice Area, 
	       the device shall start a hysteresis timer and domain selection will not notify IMS about voice preference until the expiry of hysteresis timer. */
typedef struct {
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; This API retrieves last known SSAC hysteresis timer. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of 
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Response Message; This API retrieves last known SSAC hysteresis timer. */
typedef struct {
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; This API retrieves HDR Sector ID, Pilot Pseudo-random noise, 
	           and MAC index. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of 
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Response Message; This API retrieves HDR Sector ID, Pilot Pseudo-random noise, 
	           and MAC index. */
typedef struct {
  ...
  /**<   Sector ID value as 128 bit address.
  */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; This API retrieves the HDR data rate control. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of 
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Response Message; This API retrieves the HDR data rate control. */
typedef struct {
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; This API sets Radio Policy Manager details if it is active */
typedef struct {
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Response Message; This API sets Radio Policy Manager details if it is active */
typedef struct {
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; This API retrieves Radio Policy Manager details if it is active */
typedef struct {
  /* This element is a placeholder to prevent the declaration of 
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Response Message; This API retrieves Radio Policy Manager details if it is active */
typedef struct {
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; This API controls enabling/disabling of the Radio Policy Manager */
typedef struct {

  /* Mandatory */
  /*  RPM state */
  uint8_t rpm_state;
  /**<   Desired status of RPM. Values: \n
       - 0x00 -- Disabled \n
       - 0x01 -- Enabled
  */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Response Message; This API controls enabling/disabling of the Radio Policy Manager */
typedef struct {
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; This API retrieves the previous carrier aggregation event info. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of 
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Response Message; This API retrieves the previous carrier aggregation event info. */
typedef struct {
