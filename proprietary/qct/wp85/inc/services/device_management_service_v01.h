...
#define DMS_V01_IDL_MINOR_VERS 0x23
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define DMS_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
/* SWISTART */
#ifndef SIERRA
#define DMS_V01_MAX_MESSAGE_ID 0x005C
#else
#define DMS_V01_MAX_MESSAGE_ID 0x6569;
#endif
/* SWISTOP */
/**
    @}
...
typedef struct {
  ...
  */
  ...
  #SWISTART
  contain Part number, Revision number, format is <PRI PN><space><Revision>
  PRI PN: 7 digits (xxxxxxx)
  Revision: 2 digits major version + 2 digits minor version (xx.xx)
  #SWISTOP
  */
...
/** @addtogroup sierra_swi_dms_api_qmi_aggregates
    @{
  */
  /** Struct transfer_byte_mode_type_v01 is both used in dms_swi_get_map_uart_resp_msg_v01
    and dms_swi_set_map_uart_req_msg_v01, its parameter has different meaning in the two 
    scenarios:
    
    When used in dms_swi_get_map_uart_resp_msg_v01, the first parameter means the service
    type of UART1, the second parameter means the service type of UART2

    When used in dms_swi_set_map_uart_req_msg_v01, the first parameter means the service
    type wanted set, the second parameter means the UART number wanted to be set */
typedef struct {
...
typedef struct {
  ...
  uint64_t gw_mask;
  /**<  
    GW-Mask: Please check the band mask in table 2-2
   */
...
/*
 * dms_swi_get_active_bands_req_msg is empty
 * typedef struct {
 * }dms_swi_get_active_bands_req_msg_v01;
 */

/** @addtogroup dms_qmi_messages
    @{
  */
/** Response Message; This QMI is to get the current active bands from the device. */
typedef struct {
  ...
  /**<  
    TDS-Mask: Please check the band mask in table 2-2
   */
}dms_swi_get_active_bands_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Request Message; This QMI is used to set active band sets. The set command can only accept the sub-mask of the all mask support by the device. If the sub-mask is not available, the QMI will response ERROR. */
typedef struct {
  ...
  /**<  
    TDS-Mask: Please check the band mask in table 2-2
   */
}dms_swi_set_active_bands_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Response Message; This QMI is used to set active band sets. The set command can only accept the sub-mask of the all mask support by the device. If the sub-mask is not available, the QMI will response ERROR. */
typedef struct {

  /* Mandatory */
  /*  Result Code */
  qmi_response_type_v01 resp;
}dms_swi_set_active_bands_resp_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  /* Mandatory */
  /*  firmware_preference */
  uint32_t firmware_preference;
  /**<  
    Binary value containing the firmware package ID that is preferred
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Request Message; This message queries the firmware preference. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Request Message; This message queries a list of the firmware images stored in device memory, indicates the 2 running image, and provides associated storage information. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Request Message; This message queries a list of the firmware images stored in device memory, indicates the running image, and provides associated storage information. This message returns information about all the firmware and PRI images stored on the device. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
#define QMI_DMS_SWI_GET_ACTIVE_BANDS_REQ_V01 0x5578
#define QMI_DMS_SWI_GET_ACTIVE_BANDS_RESP_V01 0x5578
#define QMI_DMS_SWI_SET_ACTIVE_BANDS_REQ_V01 0x5579
#define QMI_DMS_SWI_SET_ACTIVE_BANDS_RESP_V01 0x5579
/* GOBI_ADDENDUM_START */
