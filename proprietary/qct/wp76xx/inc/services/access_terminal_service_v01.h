...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/4.3.3/at/api/access_terminal_service_v01.h#2 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#else /* SIERRA */
/* Need to increase 156 bytes more for the response message */
#define QMI_AT_NUM_TOKEN_MAX_V01 256
#define QMI_AT_CMD_RESP_LEN_MAX_V01 256
#endif /* !SIERRA */
/* SWISTOP */
/**
    @}
