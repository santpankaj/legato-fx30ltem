...
*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  Copyright (c) 2006-2015, 2017 Qualcomm Technologies, Inc.
  All rights reserved.
...
/* This file was generated with Tool version 6.14.7 
   It was generated on: Mon May 29 2017 (Spin 0)
...
#define WDS_V01_IDL_MINOR_VERS 0x85
...
#define QMI_WDS_PROFILE_ID_SETS_MAX_V01 256
#endif /* SIERRA */
/* SWISTOP */
 ...
 */
  ...
  /**<   - 1 -- TRUE -- Disallow the call if device is in roaming 
  ...
  */
  ...
  /**<   - 1 -- TRUE -- Device attempts to bring up
       a call that supports mobile originated exceptional data.
       Application should bring up MO exceptional call 
       only when they want to sent MO exception data. \n
	   - 0 -- FALSE -- Default
  */
...
#define QMI_WDS_MASK_PROFILE_TYPE_3GPP_V01 ((wds_profile_type_mask_v01)0x01ull) 
#define QMI_WDS_MASK_PROFILE_TYPE_3GPP2_V01 ((wds_profile_type_mask_v01)0x02ull) 
typedef uint64_t wds_profiles_persistence_mask_v01;
#define QMI_WDS_PROFILE_NON_PERSISTENT_V01 ((wds_profiles_persistence_mask_v01)0x01ull) 
#define QMI_WDS_PROFILE_PERSISTENT_V01 ((wds_profiles_persistence_mask_v01)0x02ull) 
typedef uint64_t wds_profiles_client_type_mask_v01;
#define WDS_PROFILE_CLIENT_TE_V01 ((wds_profiles_client_type_mask_v01)0x01ull) 
#define WDS_PROFILE_CLIENT_ANY_V01 ((wds_profiles_client_type_mask_v01)0x80ull) 
/** @addtogroup wds_qmi_messages
    @{
  */
...
typedef struct {
  ...
  /**<   Identifies the technology type of the profile. Values: \n
      - QMI_WDS_MASK_PROFILE_TYPE_3GPP (0x01) -- 
      - QMI_WDS_MASK_PROFILE_TYPE_3GPP2 (0x02) -- 
 */
  ...
  /**<   Identifies the persistence property of the profiles to be deleted. Values: \n
      - QMI_WDS_PROFILE_NON_PERSISTENT (0x01) -- 
      - QMI_WDS_PROFILE_PERSISTENT (0x02) -- 
 */
  ...
  /**<   Identifies the client that created the profiles which need to be deleted using this message. Values: \n
      - WDS_PROFILE_CLIENT_TE (0x01) -- 
      - WDS_PROFILE_CLIENT_ANY (0x80) -- 
 */
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Indication Message; Indicates result of the delete all profiles request. */
typedef struct {
...
typedef enum {
  ...
  WDS_3GPP_RAB_REJECT_CONGESTION_V01 = 10, /**<  Network cannot serve the request from MS because of congestion */
  ...
  WDS_3GPP_RAB_REJECT_LRRC_CONN_EST_FAILURE_CONN_REJECT_V01 = 14, /**<  Connection establishment failed due to NW rejecting UE connection request */
  WDS_3GPP_RAB_REJECT_EMM_T3417_EXPIRED_V01 = 15, /**<  T3417 expires for service request procedure  */
  WDS_3GPP_RAB_REJECT_EMM_T3417_EXT_EXPIRED_V01 = 16, /**<  ESR fails as T3417 EXT timer expires    */
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Indication Message; Indicates information related to rejection of 3GPP RAB establishment */
typedef struct {
  ...
  /**<   Values: \n
      ...
      - WDS_3GPP_RAB_REJECT_CONGESTION (10) --  Network cannot serve the request from MS because of congestion
      ...
      - WDS_3GPP_RAB_REJECT_LRRC_CONN_EST_FAILURE_CONN_REJECT (14) --  Connection establishment failed due to NW rejecting UE connection request
      - WDS_3GPP_RAB_REJECT_EMM_T3417_EXPIRED (15) --  T3417 expires for service request procedure 
      - WDS_3GPP_RAB_REJECT_EMM_T3417_EXT_EXPIRED (16) --  ESR fails as T3417 EXT timer expires   
 */
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Request Message; Queries the information related to latest RAB Reject by network */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Response Message; Queries the information related to latest RAB Reject by network */
typedef struct {
...
typedef struct {
  ...
  /* Optional */
  /*  Throttled PDN attach reject timer info */
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Request Message; set the throttled PDN attach reject timer. */
typedef struct {
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Response Message; set the throttled PDN attach reject timer. */
typedef struct {
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Request Message; Subsequent uplink and downlink data transfer information from TE  
            to modem for releasing NAS signaling. */
typedef struct {
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Response Message; Subsequent uplink and downlink data transfer information from TE  
            to modem for releasing NAS signaling. */
typedef struct {
...
/* SWISTART */
#ifdef SIERRA
/** @addtogroup swi_wds_qmi_aggregates
    @{
  */
typedef struct {
  ...
  /**<   Profile index
                          ...
                          */
}swi_profile_type_v01;  /* Type */
/**
    @}
  */

/** @addtogroup swi_wds_qmi_messages
    @{
  */
/** Request Message; This message creates configured profile with specified settings.
         This message should be used instead of QMI_WDS_CREATE_PROFILE to create
         3GPP2 profile and/or when specific profile index is desired to get
         populated. */
typedef struct {

  /* Mandatory */
  /*  profile */
  swi_profile_type_v01 profile;
...
/** @addtogroup swi_wds_qmi_messages
    @{
  */
/** Response Message; This message creates configured profile with specified settings.
         This message should be used instead of QMI_WDS_CREATE_PROFILE to create
         3GPP2 profile and/or when specific profile index is desired to get
         populated. */
typedef struct {
...
typedef struct {
  ...
  /**<  
    Context Id
    Valid ID for 3GPP technology is 1 ¨C 16.
    Valid ID for 3GPP2 technology is 101 ¨C 107.
   */
...
/** @addtogroup swi_wds_qmi_messages
    @{
  */
/** Request Message; This message requests device to return various 3GPP configuration items. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}wds_swi_get_3gpp_cfg_item_req_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  uint16_t profile_list_len;
  /**<
     Profile list length
     Range of profiles: 1-4
   */

  uint16_t profile_list;
  /**<
     Profile list[0]
     1-16 (9x15 and before) or
     1-24 (9x30 and onwards)
   */

  uint16_t profile_list1;
  /**<
     Profile list[1]
     1-16 (9x15 and before) or
     1-24 (9x30 and onwards)
  ...
  uint16_t profile_list3;
  /**<
     Profile list[3]
     1-16 (9x15 and before) or
     1-24 (9x30 and onwards)
   */
}profile_list_type_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup swi_wds_qmi_messages
    @{
  */
/** Response Message; This message requests device to return various 3GPP configuration items. */
typedef struct {
  ...
  /* Optional */
  /*  LTE Attach Profile */
  uint8_t lte_attach_profile_valid;  /**< Must be set to true if lte_attach_profile is being passed */
  uint16_t lte_attach_profile;

  /* Optional */
  /*  Profile List */
  uint8_t profile_list_valid;  /**< Must be set to true if profile_list is being passed */
  profile_list_type_v01 profile_list;
  ...
  /* Optional */
  /*  3GPP Release */
  uint8_t release_valid;  /**< Must be set to true if release is being passed */
  uint8_t release;
  /**<
     0 – Release 99
     1 – Release 5
  ...
  /* Optional */
  /*  LTE Attach Profile List */
  uint8_t lte_attach_profile_list_valid;  /**< Must be set to true if lte_attach_profile_list is being passed */
  uint32_t lte_attach_profile_list_len;  /**< Must be set to # of elements in lte_attach_profile_list */
  uint16_t lte_attach_profile_list[QMI_WDS_PROFILE_ID_SETS_MAX_V01];
}wds_swi_get_3gpp_cfg_item_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup swi_wds_qmi_messages
    @{
  */
/** Request Message; This message requests device to update various 3GPP configuration items. */
typedef struct {
  ...
  uint32_t lte_attach_profile_list_len;  /**< Must be set to # of elements in lte_attach_profile_list */
  uint16_t lte_attach_profile_list[QMI_WDS_PROFILE_ID_SETS_MAX_V01];
}wds_swi_set_3gpp_cfg_item_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup swi_wds_qmi_messages
    @{
  */
/** Response Message; This message requests device to update various 3GPP configuration items. */
typedef struct {
  ...
  qmi_response_type_v01 resp;
  /**<   Standard response type.*/
}wds_swi_set_3gpp_cfg_item_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup swi_wds_qmi_messages
    @{
  */
/** Request Message; This message allows the host to configure and receive notifications for modem profile updates    */
typedef struct {
 ...
 /**<
    ...
    1 – enabled
  */
}wds_swi_profile_change_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup swi_wds_qmi_messages
    @{
  */
/** Response Message; This message allows the host to configure and receive notifications for modem profile updates    */
typedef struct {
  ...
  qmi_response_type_v01 resp;
  /**<   Standard response type.*/
}wds_swi_profile_change_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup swi_wds_qmi_messages
    @{
  */
/** Indication Message; This message allows the host to configure and receive notifications for modem profile updates    */
typedef struct {

  /* Mandatory */
  /*  Profile Change */
  profile_change_type_v01 profile;
  /**<  Profile Change */
  ...
  uint8_t source;
  /**<
     Profile change was initiated by:
     0 – Modem (AT)
     1 – Host (QMI client)
     2 – OMADM
   */
}wds_swi_profile_change_ind_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  /**<
     ...
     0x00000200 – Rx packets dropped
   */
}rm_transfer_statistics_indicator_type_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup swi_wds_qmi_messages
    @{
  */
/** Request Message; This message allows the host to configure and receive notifications for RM transfer statistics.     */
typedef struct {

  /* Optional */
  /*  RM Transfer Statistics Indicator */
  uint8_t rm_transfer_statistics_indicator_valid;  /**< Must be set to true if rm_transfer_statistics_indicator is being passed */
  rm_transfer_statistics_indicator_type_v01 rm_transfer_statistics_indicator;
}wds_swi_rm_transfer_statistics_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup swi_wds_qmi_messages
    @{
  */
/** Response Message; This message allows the host to configure and receive notifications for RM transfer statistics.     */
typedef struct {
  ...
  qmi_response_type_v01 resp;
  /**<   Standard response type.*/
}wds_swi_rm_transfer_statistics_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup swi_wds_qmi_messages
    @{
  */
/** Indication Message; This message allows the host to configure and receive notifications for RM transfer statistics.     */
typedef struct {
  ...
  uint32_t rx_dropped_count;
  /**<  Number of incoming packets dropped.*/
}wds_swi_rm_transfer_statistics_ind_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup swi_wds_qmi_messages
    @{
  */
/** Request Message; This message is used to get Data Loopback settings.    */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}wds_swi_get_data_loopback_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup swi_wds_qmi_messages
    @{
  */
/** Response Message; This message is used to get Data Loopback settings.    */
typedef struct {
  ...
  /* Mandatory */
  /*  Loopback Multiplier */
  uint8_t loopback_multiplier;
  /**<
     Number of downlink bytes to send for each uplink byte
     Replication count.
   */
}wds_swi_get_data_loopback_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup swi_wds_qmi_messages
    @{
  */
/** Request Message; This message is used to set Data Loopback settings.    */
typedef struct {
  ...
  /**<
     ...
     Replication count.
   */
}wds_swi_set_data_loopback_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup swi_wds_qmi_messages
    @{
  */
/** Response Message; This message is used to set Data Loopback settings.    */
typedef struct {

  /* Mandatory */
  /*  Result Code */
  qmi_response_type_v01 resp;
}wds_swi_set_data_loopback_resp_msg_v01;
...
/** @addtogroup swi_wds_qmi_messages
    @{
  */
/** Request Message; This message is used to query current Tx/Rx channel bitrate of
	 the current packet data connection based on IP layer traffic statistics    */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}wds_swi_get_current_ip_channel_rate_req_msg_v01;
...
typedef struct {
  ...
  uint32_t max_channel_tx_rate;
  /**<
     Maximum total Tx rate that modem is able to support
     in current serving system in bits per second.
   */

  uint32_t max_channel_rx_rate;
  /**<
     Maximum total Rx rate that modem is able to support
     in current serving system in bits per second.
   */
}channel_rate_type_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup swi_wds_qmi_messages
    @{
  */
/** Response Message; This message is used to query current Tx/Rx channel bitrate of
	 the current packet data connection based on IP layer traffic statistics    */
typedef struct {
  ...
  /* Mandatory */
  /*  Channel Rate */
  channel_rate_type_v01 channel_rate;
  /**<  Channel Rate*/
}wds_swi_get_current_ip_channel_rate_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup swi_wds_qmi_messages
    @{
  */
/** Request Message; This QMI interface is used to get the default profile number
            based on the profile type and profile family, which is
            specific to Sierra Wireless. */
typedef struct {
...
/** @addtogroup swi_wds_qmi_messages
    @{
  */
/** Response Message; This QMI interface is used to get the default profile number
            based on the profile type and profile family, which is
            specific to Sierra Wireless. */
typedef struct {
...
/* SWISTART */
#ifdef SIERRA
//#define REMOVE_QMI_WDS_SWI_CREATE_PROFILE_V01
//#define REMOVE_QMI_WDS_SWI_GET_3GPP_CFG_ITEM_V01
//#define REMOVE_QMI_WDS_SWI_SET_3GPP_CFG_ITEM_V01
//#define REMOVE_QMI_WDS_SWI_PDP_RUNTIME_SETTINGS_V01
//#define REMOVE_QMI_WDS_SWI_PROFILE_CHANGE_V01
//#define REMOVE_QMI_WDS_SWI_PROFILE_CHANGE_IND_V01
//#define REMOVE_QMI_WDS_SWI_RM_TRANSFER_STATISTICS_V01
//#define REMOVE_QMI_WDS_SWI_RM_TRANSFER_STATISTICS_IND_V01
//#define REMOVE_QMI_WDS_SWI_GET_DATA_LOOPBACK_V01
//#define REMOVE_QMI_WDS_SWI_SET_DATA_LOOPBACK_V01
//#define REMOVE_QMI_WDS_SWI_GET_CURRENT_IP_CHANNEL_RATE_V01
#endif /* SIERRA */
/* SWISTOP */
...
#define QMI_WDS_SWI_GET_3GPP_CFG_ITEM_REQ_V01 0x5559
#define QMI_WDS_SWI_GET_3GPP_CFG_ITEM_RESP_V01 0x5559
#define QMI_WDS_SWI_SET_3GPP_CFG_ITEM_REQ_V01 0x555A
#define QMI_WDS_SWI_SET_3GPP_CFG_ITEM_RESP_V01 0x555A
#define QMI_WDS_SWI_PDP_RUNTIME_SETTINGS_REQ_V01 0x555B
#define QMI_WDS_SWI_PDP_RUNTIME_SETTINGS_RESP_V01 0x555B
#define QMI_WDS_SWI_PROFILE_CHANGE_REQ_V01 0x5567
#define QMI_WDS_SWI_PROFILE_CHANGE_RESP_V01 0x5567
#define QMI_WDS_SWI_PROFILE_CHANGE_IND_V01 0x5567
#define QMI_WDS_SWI_RM_TRANSFER_STATISTICS_REQ_V01 0x5568
#define QMI_WDS_SWI_RM_TRANSFER_STATISTICS_RESP_V01 0x5568
#define QMI_WDS_SWI_RM_TRANSFER_STATISTICS_IND_V01 0x5568
#define QMI_WDS_SWI_GET_DATA_LOOPBACK_REQ_V01 0x5569
#define QMI_WDS_SWI_GET_DATA_LOOPBACK_RESP_V01 0x5569
#define QMI_WDS_SWI_SET_DATA_LOOPBACK_REQ_V01 0x556A
#define QMI_WDS_SWI_SET_DATA_LOOPBACK_RESP_V01 0x556A
#define QMI_WDS_SWI_GET_CURRENT_IP_CHANNEL_RATE_REQ_V01 0x556B
#define QMI_WDS_SWI_GET_CURRENT_IP_CHANNEL_RATE_RESP_V01 0x556B
