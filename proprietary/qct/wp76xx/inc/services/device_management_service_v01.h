...
*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  Copyright (c) 2006-2016 Qualcomm Technologies, Inc.
  All rights reserved.
...
#else
#define DMS_V01_MAX_MESSAGE_ID 0x656D
#endif
/* SWISTOP */
/**
    @}
...
/*GOBI_ADDENDUM START*/
#define QMI_DMS_UNIQUE_ID_SIZE_V01 16
#define QMI_DMS_BUILD_ID_SIZE_V01 32
#define QMI_DMS_NUM_SUPPORTED_IMAGE_TYPES_V01 2
#define QMI_DMS_STORED_IMAGE_SUBLIST_SIZE_V01 50
#define QMI_DMS_PRI_INFO_SIZE_V01 32
/*GOBI_ADDENDUM STOP*/

#define QMI_DMS_PRODUCT_NAME_SIZE_V01 16
#define QMI_DMS_BCH_VERSTR_SIZE_V01 84
#define QMI_DMS_PRODUCT_SKU_SIZE_V01 8
#define QMI_DMS_CARRIERID_SIZE_V01 4
#define QMI_DMS_PRIID_SIZE_V01 15
#define QMI_DMS_CARRIER_PRI_NAME_SIZE_V01 16
#define QMI_DMS_CARRIER_PRI_REV_SIZE_V01 12
#define QMI_DMS_RF_DEVICES_MAX_V01 10
...
#define QMI_DMS_NUM_SUPPORTED_IMAGE_TYPES_V01 2
#define QMI_DMS_GOBI_IM_UNIQUE_ID_MAX_V01 16
#define QMI_DMS_GOBI_IM_BUILD_ID_MAX_V01 32
#define QMI_DMS_FWUPDATERESTRLEN_V01 15
#define QMI_DMS_FWUPDATELOGSTRLEN_V01 256
...
#define QMI_DMS_CRASH_STRING_SIZE_V01 64
#define QMI_DMS_GCDUMP_STRING_SIZE_V01 2048
#define QMI_DMS_CRASH_INFO_LIST_SIZE_V01 4
#define QMI_DMS_CUST_ID_SIZE_V01 64
#define QMI_DMS_CUST_VALUE_SIZE_V01 8
#define QMI_DMS_CUST_SETTING_LIST_SIZE_V01 50
#define QMI_DMS_L_MASK_SIZE_V01 2
#define QMI_RECOVERY_STR_MAX_V01 256
#endif /* SIERRA */
/* SWISTOP */
/**
    @}
  ...
  /**<    explicit_config_index specifies if the current configuration is Modem selected or HOS specified.
        explicit_config_index Values:\n
             ...
             - "Any other valid value" - HLOS selected static configuration and 
              points to an index in list of device_cfg_list of \93device_config_list\94 TLV.
   */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Request Message; This sets the firmware package preference maintained by the device. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}dms_set_firmware_preference_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Response Message; This sets the firmware package preference maintained by the device. */
typedef struct {

  /* Mandatory */
  /*  Result Code */
  qmi_response_type_v01 resp;
}dms_set_firmware_preference_resp_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  /* This element is a placeholder to prevent the declaration of 
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}dms_get_firmware_pref_req_msg_v01;
...
typedef struct {
  ...
  uint8_t unique_id[QMI_DMS_UNIQUE_ID_SIZE_V01];
  /**<
    Image unique identifier
   */

  uint32_t build_id_len;  /**< Must be set to # of elements in build_id */
  char build_id[QMI_DMS_BUILD_ID_SIZE_V01];
  /**<  
    String containing image build information
   */
}image_preference_entry_type_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Response Message; This message queries the firmware preference. */
typedef struct {
  ...
  /* Mandatory */
  /*  image_preference_list */
  uint32_t image_preference_list_len;  /**< Must be set to # of elements in image_preference_list */
  image_preference_entry_type_v01 image_preference_list[QMI_DMS_NUM_SUPPORTED_IMAGE_TYPES_V01];
  /**<  
    An entry consists of the following parameters: image_type, unique_id, build_id_len, and build_id. If no entries are found, this field will be set to 0 and no data will follow.
  */
}dms_get_firmware_pref_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Request Message; This message sets the firmware preference. */
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  download_override */
  uint8_t download_override_valid;  /**< Must be set to true if download_override is being passed */
  uint8_t download_override;
  /**<
    Indicates whether the images should be downloaded from the host even if already present in device storage. Setting is valid only for the current transaction.
    0x01 - Force downloading of
   */

  /* Optional */
  /*  modem_storage_index */
  uint8_t modem_storage_index_valid;  /**< Must be set to true if modem_storage_index is being passed */
  uint8_t modem_storage_index;
  /**<
    Index in storage where the modem image should be stored if it is downloaded
   */
}dms_set_firmware_pref_req_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t image_type_len;  /**< Must be set to # of elements in image_type */
  uint8_t image_type[QMI_DMS_NUM_SUPPORTED_IMAGE_TYPES_V01];
  /**<
    Image type:
    0 Modem image
    1 PRI image
   */
}image_download_list_type_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Response Message; This message sets the firmware preference. */
typedef struct {
  ...
  /* Mandatory */
  /*  image_download_list */
  image_download_list_type_v01 image_download_list;

  /* Optional */
  /*  maximum_build_id_length */
  uint8_t maximum_build_id_length_valid;  /**< Must be set to true if maximum_build_id_length is being passed */
  uint8_t maximum_build_id_length;
  /**<
    Maximum length of the build ID field allowed by the implementation
   */
}dms_set_firmware_pref_resp_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  /* This element is a placeholder to prevent the declaration of 
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}dms_list_stored_images_req_msg_v01;
...
typedef struct {
  ...
  /**<
    Index in storage where the image is located. If not relevant for the image type, this field will be set to 0xFF.
   */

  uint8_t failure_count;
  /**<
    Number of consecutive write attempts to this storage index that have failed. If not relevant for the image type or not supported, this field will be set to 0xFF.
   */
  ...
  /**<
    String containing image build information
   */
}stored_image_sublist_entry_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  /**<
    Index of the currently running image in the following sub-list. This value starts at 0. If the currently running image is not saved in the device storage, for example if it has been deleted, then this field will be set to 0xFF.
   */

  uint32_t sublist_entries_len;  /**< Must be set to # of elements in sublist_entries */
  stored_image_sublist_entry_type_v01 sublist_entries[QMI_DMS_STORED_IMAGE_SUBLIST_SIZE_V01];
  /**<  
    A sub-list entry consists of the following parameters: storage_index, failure_count, unique_id, build_id_len, and build_id.
  */
}stored_image_entry_type_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Response Message; This message queries a list of the firmware images stored in device memory, indicates the 2 running image, and provides associated storage information. */
typedef struct {
  ...
  /* Mandatory */
  /*  stored_image_list */
  uint32_t stored_image_list_len;  /**< Must be set to # of elements in stored_image_list */
  stored_image_entry_type_v01 stored_image_list[QMI_DMS_NUM_SUPPORTED_IMAGE_TYPES_V01];
  /**<  
    A list entry contains the following parameters: image_type, max_images, running_image and sublist_len; and one or more sub-list entries with the following parameters: storage_index, unique_id, build_id_len, and build_id.
  */
}dms_list_stored_images_resp_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  /**<
    String containing image build information
   */
}image_identifier_type_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Request Message; This message removes a firmware image from device memory. */
typedef struct {

  /* Mandatory */
  /*  image_identifier */
  image_identifier_type_v01 image_identifier;
}dms_delete_stored_image_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Response Message; This message removes a firmware image from device memory. */
typedef struct {

  /* Mandatory */
  /*  Result Code */
  qmi_response_type_v01 resp;
}dms_delete_stored_image_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Request Message; This message retrieves extended information about a firmware image stored in device memory. */
typedef struct {

  /* Mandatory */
  /*  image_identifier */
  image_identifier_type_v01 image_identifier;
}dms_get_stored_image_info_req_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  uint16_t boot_maj_ver;
  /**<
    Boot major version
   */

  uint16_t boot_min_ver;
  /**<
    Boot minor version
   */
}boot_version_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  char pri_info[QMI_DMS_PRI_INFO_SIZE_V01];
  /**<
    PRI information
   */
}pri_version_type_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Response Message; This message retrieves extended information about a firmware image stored in device memory. */
typedef struct {
  ...
  /* Optional */
  /*  boot_version */
  uint8_t boot_version_valid;  /**< Must be set to true if boot_version is being passed */
  boot_version_type_v01 boot_version;

  /* Optional */
  /*  pri_version */
  uint8_t pri_version_valid;  /**< Must be set to true if pri_version is being passed */
  pri_version_type_v01 pri_version;

  /* Optional */
  /*  oem_lock_id */
  uint8_t oem_lock_id_valid;  /**< Must be set to true if oem_lock_id is being passed */
  uint32_t oem_lock_id;
  /**<
    OEM Lock ID
   */
}dms_get_stored_image_info_resp_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  /* This element is a placeholder to prevent the declaration of 
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}dms_swi_get_stored_images_req_msg_v01;
...
typedef struct {
  ...
  /**<
    Sierra added fields:
    swi_length total length of the following Sierra added fields (excluding length of swi_length itself)
 New fields will be always added to the end to maintain compatibility. Swi_length field can be used to skip the following fields even if the host didn't understand the new fields.
   */

  uint8_t lru_rank;
  /**<
    Sierra added fields:
Least Recently Used (LRU) rank for the firmware image. This field is not relevant to PRI image and will be 0xFF
   */

  uint8_t switch_failures;
  /**<
    Sierra added fields:
Number of consecutive firmware image switching failures using this storage index. If not relevant for the image type or not supported, this field will be set to 0xFF.
   */
...
0x01 FOTA download
0xFF Not applicable
This field is only relevant to firmware images. For other image types, such as PRI images, this field will always be set to 0xFF.
   */
}stored_image_swi_sublist_entry_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t swi_sublist_entries_len;  /**< Must be set to # of elements in swi_sublist_entries */
  stored_image_swi_sublist_entry_type_v01 swi_sublist_entries[QMI_DMS_STORED_IMAGE_SUBLIST_SIZE_V01];
  /**<  
    A sub-list entry consists of the following parameters: storage_index, failure_count, unique_id, build_id_len, build_id and sierra fields.
  */
}stored_image_swi_entry_type_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Response Message; This message queries a list of the firmware images stored in device memory, indicates the running image, and provides associated storage information. This message returns information about all the firmware and PRI images stored on the device. */
typedef struct {
  ...
  /* Mandatory */
  /*  stored_image_swi_list */
  uint32_t stored_image_swi_list_len;  /**< Must be set to # of elements in stored_image_swi_list */
  stored_image_swi_entry_type_v01 stored_image_swi_list[QMI_DMS_NUM_SUPPORTED_IMAGE_TYPES_V01];
}dms_swi_get_stored_images_resp_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  char model_id[QMI_DMS_PRODUCT_NAME_SIZE_V01 + 1];
  /**<   Device Model. 
                                                      E.g. MC7700
                                                  */
  ...
  char boot_ver[QMI_DMS_BCH_VERSTR_SIZE_V01 + 1];
  /**<   Boot Version string
  ...
  char Appl_ver[QMI_DMS_BCH_VERSTR_SIZE_V01 + 1];
  ...
  char sku_id[QMI_DMS_PRODUCT_SKU_SIZE_V01 + 1];
  /**<   Product SKU ID  */

  /* Optional */
  /*  Package Name */
  uint8_t pkg_name_valid;  /**< Must be set to true if pkg_name is being passed */
  char pkg_name[QMI_DMS_BCH_VERSTR_SIZE_V01 + 1];
  ...
  char carrier_id[QMI_DMS_CARRIERID_SIZE_V01 + 1];
  ...
  /*  PRI revision */
  uint8_t pri_rev_valid;  /**< Must be set to true if pri_rev is being passed */
  char pri_rev[QMI_DMS_PRIID_SIZE_V01 + 1];
  /**<   OEM PRI revision in major.minor numeric format    */

  /* Optional */
  /*  Carrier PRI Name */
  uint8_t carrier_pri_name_valid;  /**< Must be set to true if carrier_pri_name is being passed */
  char carrier_pri_name[QMI_DMS_CARRIER_PRI_NAME_SIZE_V01 + 1];
  /**<   Current Carrier PRI Name */

  /* Optional */
  /*  Carrier PRI Revision */
  uint8_t carrier_pri_rev_valid;  /**< Must be set to true if carrier_pri_rev is being passed */
  char carrier_pri_rev[QMI_DMS_CARRIER_PRI_REV_SIZE_V01 + 1];
  /**<   Current Carrier PRI revision in major.minor_buildver numeric format */
...
/** @addtogroup sierra_swi_dms_api_qmi_messages
    @{
  */
/** Response Message; This message query the modem\92s USB interface configuration, 
...
/** @addtogroup sierra_swi_dms_api_qmi_messages
    @{
  */
/** Response Message; This message query the modem\92s FCC authentication setting */
typedef struct {
...
typedef struct {
  ...
  char unique_id[QMI_DMS_GOBI_IM_UNIQUE_ID_MAX_V01];
...
typedef struct {
  ...
  char refstring[QMI_DMS_FWUPDATERESTRLEN_V01 + 1];

  /* Optional */
  /*  RefString */
  uint8_t logstring_valid;  /**< Must be set to true if logstring is being passed */
  char logstring[QMI_DMS_FWUPDATELOGSTRLEN_V01 + 1];
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Request Message; This command queries the settings for SWI CUSTOM commands. */
typedef struct {

  /* Optional */
  /*  cust_id */
  uint8_t cust_id_valid;  /**< Must be set to true if cust_id is being passed */
  char cust_id[QMI_DMS_CUST_ID_SIZE_V01 + 1];
  /**<
    Customization ID presented by a string (Maximum 64 bytes)
   */
  ...
  /**<
    List type requested:
    0 - all customizations
    other - reserved
   */
}dms_swi_get_cust_features_req_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t cust_id_len;  /**< Must be set to # of elements in cust_id */
  char cust_id[QMI_DMS_CUST_ID_SIZE_V01];
  /**<
    Customization ID (Maximum 64 bytes)
   */

  /* !< 80-N0846-1 document mentions specifying the no of bytes for
      length has been deprecated but we are using it to follow the 
      Sierra QMI Specification
   */
  uint32_t cust_value_len;  /**< Must be set to # of elements in cust_value */
  uint8_t cust_value[QMI_DMS_CUST_VALUE_SIZE_V01];
  /**<
  ...
  uint16_t cust_attr;
  /**<
    Bit-masked customization attribute
    bit 0:
    0 - read only
    1 - read/write through QMI
   */
}customization_setting_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t cust_setting_list_len;  /**< Must be set to # of elements in cust_setting_list */
  customization_setting_type_v01 cust_setting_list[QMI_DMS_CUST_SETTING_LIST_SIZE_V01];
  /**<
    customization setting list
   */
}customization_list_type_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Response Message; This command queries the settings for SWI CUSTOM commands. */
typedef struct {
  ...
  uint8_t customization_setting_valid;  /**< Must be set to true if customization_setting is being passed */
  customization_setting_type_v01 customization_setting;

  /* Optional */
  /*  customization_list */
  uint8_t customization_list_valid;  /**< Must be set to true if customization_list is being passed */
  customization_list_type_v01 customization_list;
}dms_swi_get_cust_features_resp_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  /**<
    Customization Setting Value (Maximum 8 bytes)
   */
}customization_setting_simple_type_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Request Message; This command allows for the setting of SWI CUSTOM commands. */
typedef struct {

  /* Optional */
  /*  customization_setting */
  uint8_t customization_setting_valid;  /**< Must be set to true if customization_setting is being passed */
  customization_setting_simple_type_v01 customization_setting;
}dms_swi_set_cust_features_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Response Message; This command allows for the setting of SWI CUSTOM commands. */
typedef struct {

  /* Mandatory */
  /*  Result Code */
  qmi_response_type_v01 resp;
}dms_swi_set_cust_features_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup sierra_swi_dms_api_qmi_messages
    @{
  */
/** Response Message; This message retrieves device\92s recondition flag,
...
/** @addtogroup sierra_swi_dms_api_qmi_messages
    @{
  */
/** Request Message; This command queries the crash info. The command is equivalent to at!gcdump. */
typedef struct {
  ...
  /**<
    ...
    If the Clear TLV is not provided, the default behaviour is to retain the crash data on the modem.  This is the same behaviour as providing this TLV with clear set to 0.  Note that the response will still contain the crash info if clear is set to 1, if available.  A client may read and clear the crash info in one step by setting clear to 1 in the initial request.
   */
...
typedef struct {
  ...
  uint32_t crash_string_len;  /**< Must be set to # of elements in crash_string */
  char crash_string[QMI_DMS_CRASH_STRING_SIZE_V01];
  /**<
    Crash string
   */

  uint32_t gcdump_string_len;  /**< Must be set to # of elements in gcdump_string */
  char gcdump_string[QMI_DMS_GCDUMP_STRING_SIZE_V01];
  /**<
    gcdump string for the crash
   */
}crash_info_type_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Response Message; This command queries the crash info. The command is equivalent to at!gcdump. */
typedef struct {
  ...
  /* Optional */
  /*  crash_info */
  uint8_t crash_info_list_valid;  /**< Must be set to true if crash_info_list is being passed */
  uint32_t crash_info_list_len;  /**< Must be set to # of elements in crash_info_list */
  crash_info_type_v01 crash_info_list[QMI_DMS_CRASH_INFO_LIST_SIZE_V01];
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Response Message; This command queries the action performed in the event of a crash. The command is equivalent to AT!EROPTION. */
typedef struct {
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Request Message; This command configures the action performed in the event of a crash. This setting is persistent over a device reset. The command is equivalent to AT!EROPTION. */
typedef struct {
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Response Message; This command configures the action performed in the event of a crash. This setting is persistent over a device reset. The command is equivalent to AT!EROPTION. */
typedef struct {
...
/** @addtogroup sierra_swi_dms_api_qmi_messages
    @{
  */
/** Request Message; This message queries the host device info configured
...
typedef struct {
  ...
  */
  ...
  uint8_t hostid_valid;  /**< Must be set to true if hostid is being passed */
  char hostid[QMI_DMS_HOST_DEV_INFO_MAX_V01 + 1];
  /**<   Host Device Unique ID response */
...
typedef struct {
  ...
  char osname[QMI_DMS_OS_INFO_MAX_V01 + 1];
  ...
  */
  ...
  char osversion[QMI_DMS_OS_INFO_MAX_V01 + 1];
  /**<   Null terminated ASCII string.
         Max length of 256 bytes.
  */
...
/*
 * dms_swi_get_pc_info_req_msg is empty
 * typedef struct {
 * }dms_swi_get_pc_info_req_msg_v01;
 */

/** @addtogroup dms_qmi_messages
    @{
  */
/** Response Message; This command queries the device power control status information. The command is equivalent to AT!PCINFO. */
typedef struct {
  ...
  /**<
    ...
    Operating Mode values are defined the same as for the standard DMS message QMI_DMS_GET_OPERATING_MODE_RESP.
   */
...
/** @addtogroup sierra_swi_dms_api_qmi_messages
    @{
  */
/** Request Message; This message changes the device\92s active GPS service type.  */
typedef struct {
...
/** @addtogroup sierra_swi_dms_api_qmi_messages
    @{
  */
/** Response Message; This message changes the device\92s active GPS service type.  */
typedef struct {
...
typedef struct {
  ...
  */
  ...
  /**<  
    0 No swap since power up
    1 Swap due to bad image
    2 Swap due to normal SW update
    3 Swap triggered by AT command
    4 Swap triggered by Legato API
   */
  ...
  /**<  
    1 Normal state
    2 Sync state between system 1 and system 2
    3 Sync and swap state from active system to inactive system
    4 SW recovery phase 1
    5 SW recovery phase 2
   */
  ...
  /**<  
    0x0 flag is cleared
    0x4F6F5300 means dual system is out of sync
    0x73796E63 means dual system is sync
   */
  ...
  /**<  
    0x0 flag is cleared
    0x45465343 means it is necessary to do EFS corruption action
   */
  ...
  /**<  
    0 flag is cleared
    1 means to do EDB in system 1
    2 means to do EDB in system 2
   */
...
typedef struct {
  ...
  */
  ...
  /**<  
    ...
    0x1  no error found in the RF device
  */
...
typedef struct {
 ...
 Result Code */
  ...
  dms_swi_RF_status_type_v01 RF_status[QMI_DMS_RF_DEVICES_MAX_V01];
...
/** @addtogroup sierra_swi_dms_api_qmi_messages
    @{
  */
/** Request Message; This message sets the registration state for different QMI_DMS SWI indications for the requesting control point.  This message should be extended to support new SWI indications as needed.  Indications themselves are defined separately. (Currently it supports QMI_DMS_SWI_GET_RESET_INFO_IND */
typedef struct {
  /* Optional */
  /* Reset indication status for QMI_DMS_SWI_GET_RESET_INFO_IND */
  uint8_t reset_indication_valid;  /**< Must be set to true if reset indication status is being passed */
  uint8_t reset_indication;
  /**<   0 disable
         1 enable
   */
  /* Optional */
  uint8_t fs_recovery_indication_valid;  /**< Must be set to true if fs_recovery_indication is being passed */
  uint8_t fs_recovery_indication;
  /**<   0 disable
                                             1 enable
                                          */
}dms_swi_indication_register_req_msg_v01;
...
/** @addtogroup sierra_swi_dms_api_qmi_messages
    @{
  */
/** Response Message; This message sets the registration state for different QMI_DMS SWI indications for the requesting control point.  This message should be extended to support new SWI indications as needed.  Indications themselves are defined separately. */
typedef struct {
  /* Mandatory */
  /*  Result Code */
  qmi_response_type_v01 resp;
}dms_swi_indication_register_resp_msg_v01;  /* Message */
...
/** @addtogroup sierra_swi_dms_api_qmi_messages
    @{
  */
/** Response Message; This command queries the reason for the most recent device reset or powerdown.  An indication is also supported which reports the same information just before the reset or powerdown. */
typedef struct {
...
/** @addtogroup sierra_swi_dms_api_qmi_messages
    @{
  */
/** Indication Message; The unsolicited message is sent by the service to relevant control points when the device is about to perform a controlled reset or power-down.  Relevant control points are those which registered for the indication through 	QMI_DMS_SWI_INDICATION_REGISTER. */
typedef struct {
  /* Mandatory */
  /*  reset information */
  reset_info_type_v01 reset_info;
}dms_swi_get_reset_info_ind_msg_v01;  /* Message */

/** @addtogroup sierra_swi_dms_api_qmi_messages
    @{
  */
/** Request Message; This command queries the most recent FS recovery.  An indication is also supported which reports the recovery event after FS corruption. */
typedef struct {

  /* Optional */
  /*  fs_type */
  uint8_t fs_type_valid;  /**< Must be set to true if fs_type is being passed */
  uint8_t fs_type;
  /**<
    FS type:
    0  modem EFS
    1  Linux FS
  */
}dms_swi_get_fs_recovery_info_req_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  uint16_t total_corrupted;

  uint16_t total_recovered;
}recovery_stat_type_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup sierra_swi_dms_api_qmi_messages
    @{
  */
/** Response Message; This command queries the most recent FS recovery.  An indication is also supported which reports the recovery event after FS corruption. */
typedef struct {
  ...
  /* Mandatory */
  /*  recovery status */
  recovery_stat_type_v01 recovery_stats;
  /**<   recovery stats */
  ...
  /* Optional */
  uint8_t record_num_valid;  /**< Must be set to true if record_num is being passed */
  uint16_t record_num;
  /**<   record number */

  /* Optional */
  uint8_t corruption_type_valid;  /**< Must be set to true if corruption_type is being passed */
  uint8_t corruption_type;
  /**<   corruption type:
                                       0 - general failure
                                   */

  /* Optional */
  uint8_t recovery_type_valid;  /**< Must be set to true if recovery_type is being passed */
  ...
  /* Optional */
  uint8_t description_str_valid;  /**< Must be set to true if description_str is being passed */
  char description_str[QMI_RECOVERY_STR_MAX_V01 + 1];
  /**<   Null terminated ASCII string.
                                                              Max length of 256 bytes. 
                                                          */
}dms_swi_get_fs_recovery_info_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup sierra_swi_dms_api_qmi_messages
    @{
  */
/** Indication Message; This command queries the most recent FS recovery.  An indication is also supported which reports the recovery event after FS corruption. */
typedef struct {
  ...
  /**<   Null terminated ASCII string.
                                                              Max length of 256 bytes. 
                                                          */
}dms_swi_get_fs_recovery_info_ind_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  /**<   specifies the configuration index on which Modem should act on.
         ...
         index in list of device_cfg_list of "device_config_list\94 TLV related to most recently
...
/*GOBI_ADDENDUM START*/
#define QMI_DMS_SET_FIRMWARE_PREFERENCE_REQ_V01 0x003E
#define QMI_DMS_SET_FIRMWARE_PREFERENCE_RESP_V01 0x003E
#define QMI_DMS_GET_FIRMWARE_PREF_REQ_V01 0x0047
#define QMI_DMS_GET_FIRMWARE_PREF_RESP_V01 0x0047
#define QMI_DMS_SET_FIRMWARE_PREF_REQ_V01 0x0048
#define QMI_DMS_SET_FIRMWARE_PREF_RESP_V01 0x0048
#define QMI_DMS_LIST_STORED_IMAGES_REQ_V01 0x0049
#define QMI_DMS_LIST_STORED_IMAGES_RESP_V01 0x0049
#define QMI_DMS_DELETE_STORED_IMAGE_REQ_V01 0x004A
#define QMI_DMS_DELETE_STORED_IMAGE_RESP_V01 0x004A
#define QMI_DMS_GET_STORED_IMAGE_INFO_REQ_V01 0x004C
#define QMI_DMS_GET_STORED_IMAGE_INFO_RESP_V01 0x004C
/*GOBI_ADDENDUM STOP*/
...
#define QMI_DMS_SWI_GET_CRASH_INFO_REQ_V01 0x5565
#define QMI_DMS_SWI_GET_CRASH_INFO_RESP_V01 0x5565
#define QMI_DMS_SWI_GET_FSN_REQ_V01 0x5567
#define QMI_DMS_SWI_GET_FSN_RESP_V01 0x5567
#define QMI_DMS_SWI_GET_CRASH_ACTION_REQ_V01 0x5568
#define QMI_DMS_SWI_GET_CRASH_ACTION_RESP_V01 0x5568
...
#define QMI_DMS_SWI_GET_STORED_IMAGES_REQ_V01 0X557A
#define QMI_DMS_SWI_GET_STORED_IMAGES_RESP_V01 0X557A
#define QMI_DMS_SWI_INDICATION_REGISTER_REQ_V01 0x557F
#define QMI_DMS_SWI_INDICATION_REGISTER_RESP_V01 0x557F
#define QMI_DMS_SWI_GET_RESET_INFO_REQ_V01 0x5580
#define QMI_DMS_SWI_GET_RESET_INFO_RESP_V01 0x5580
#define QMI_DMS_SWI_GET_RESET_INFO_IND_V01 0x5580
#define QMI_DMS_SWI_GET_FS_RECOVERY_INFO_REQ_V01 0x5581
#define QMI_DMS_SWI_GET_FS_RECOVERY_INFO_RESP_V01 0x5581
#define QMI_DMS_SWI_GET_FS_RECOVERY_INFO_IND_V01 0x5581
