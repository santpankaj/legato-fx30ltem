...
#else
#define NAS_V01_MAX_MESSAGE_ID 0x7561
#endif
/* SWISTOP */
/**
    @}
...
/* SWISTART */
#ifdef SIERRA
#define QMI_NAS_OTA_MESSAGE_IND_MAX_V01 65509
#endif /* SIERRA */
/* SWISTOP */
/**
    @}
...
/* SWISTART */
#ifdef SIERRA
/** @addtogroup swi_nas_qmi_aggregates
    @{
  */
typedef struct {
  ...
  uint8_t raw_data[QMI_NAS_OTA_MESSAGE_IND_MAX_V01];
  /**<
     OTA Message Content
    */
}ota_msg_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint8_t nas_minor;
  /**<  NAS Minor */
}lte_nas_release_info_type_v01;  /* Type */
/**
    @}
  */

/** @addtogroup swi_nas_qmi_messages
    @{
  */
/** Indication Message; This indication provides raw OTA NAS messages as configured
	 by the control point. */
typedef struct {

  /* Mandatory */
  /*  OTA Message */
  ota_msg_type_v01 ota_msg;
  /**<  OTA Message*/

  /* Optional */
  /* LTE NAS Release Info */
  uint8_t lte_nas_release_info_valid; /**< Must be set to true if lte_nas_release_info is being passed */
  lte_nas_release_info_type_v01 lte_nas_release_info;
  /**<  LTE NAS Release Info.  */

  /* Optional */
  /* Time */
  uint8_t time_valid;  /**< Must be set to true if time is being passed */
  uint64_t time;
  /**<  Time  */
}nas_swi_ota_ind_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup swi_nas_qmi_messages
    @{
  */
/** Indication Message; This indication provides LTE Rank Indicator information
	 to the host. */
typedef struct {

  /* Mandatory */
  /*  Rank Indicator */
  rank_ind_type_v01 rank_ind;    //!< Rank Indicator
}nas_swi_rank_ind_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup swi_nas_qmi_messages
    @{
  */
/** Request Message; This message requests the device to return the current status of modem.  */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}nas_swi_modem_status_req_msg_v01;
...
/** @addtogroup swi_nas_qmi_messages
    @{
  */
/** Response Message; This message requests the device to return the current status of modem.  */
typedef struct {
  ...
  /* Mandatory */
  /*  Common Information */
  common_info_type_v01 common_info;
  /**<   Common Information */

  /* Optional */
  /*  LTE Information */
  uint8_t lte_info_valid;  /**< Must be set to true if lte_info is being passed */
  lte_info_type_v01 lte_info;
  /**< LTE Information */
}nas_swi_modem_status_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup swi_nas_qmi_messages
    @{
  */
/** Request Message; The request command instructs the UE to perform LTE RSSI measurements on the selected Antenna.   */
typedef struct {
  ...
  uint8_t rxsel;
  /**<   Receiver Select*/
}nas_swi_get_lte_ant_info_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup swi_nas_qmi_messages
    @{
  */
/** Response Message; The request command instructs the UE to perform LTE RSSI measurements on the selected Antenna.   */
typedef struct {
  ...
  /* Optional */
  /*  Date */
  uint8_t date_time_valid;  /**< Must be set to true if date_time is being passed */
  uint32_t date_time;
  /**<  Date*/

  /* Optional */
  /*  RX0RSSI */
  uint8_t rx0_rssi_valid;  /**< Must be set to true if rx0_rssi is being passed */
  uint16_t rx0_rssi;
  /**<  RX0RSSI*/

  /* Optional */
  /*  RX1RSSI */
  uint8_t rx1_rssi_valid;  /**< Must be set to true if rx1_rssi is being passed */
  uint16_t rx1_rssi;
  /**<  RX1RSSI*/

  /* Optional */
  /*  Relative Phase */
  uint8_t phase_valid;  /**< Must be set to true if phase is being passed */
  uint16_t phase;
  /**<  Relative Phase*/
}nas_swi_get_lte_ant_info_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup swi_nas_qmi_messages
    @{
  */
/** Request Message; This command sets the operation of the Antenna/Receiver chain, either enabled or disabled.  */
typedef struct {
  ...
  uint8_t rxsel;
  /**<   ReceiverSelect.*/
}nas_swi_set_lte_ant_cfg_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup swi_nas_qmi_messages
    @{
  */
/** Response Message; This command sets the operation of the Antenna/Receiver chain, either enabled or disabled.  */
typedef struct {
  ...
  uint8_t error;
  /**<  Error  */
}nas_swi_set_lte_ant_cfg_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup swi_nas_qmi_messages
    @{
  */
/** Request Message; This command queries the status of the Antenna/Receiver chains, either enabled or disabled. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}nas_swi_get_lte_ant_cfg_req_msg_v01;
...
/** @addtogroup swi_nas_qmi_messages
    @{
  */
/** Response Message; This command queries the status of the Antenna/Receiver chains, either enabled or disabled. */
typedef struct {
  ...
  uint8_t status;
  /**<  Status  */
}nas_swi_get_lte_ant_cfg_resp_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  uint8_t lte_emm_dl;
  /**< 0 – do not report
       1 – report LTE EMM downlink messages
    */
...
/** @addtogroup swi_nas_qmi_messages
    @{
  */
/** Request Message; This message sets the registration state for different QMI_NAS  SWI indications. */
typedef struct {

  /* Optional */
  /*  OTA Message Indications */
  uint8_t ota_msg_ind_valid;  /**< Must be set to true if ota_msg_ind is being passed */
  ota_msg_ind_type_v01 ota_msg_ind;

  /* Optional */
  /*  Rank Indicator Indications */
  uint8_t rank_enable_valid;  /**< Must be set to true if rank_enable is being passed */
  uint8_t rank_enable;
  /**<  0 – Disable
        1 – Enable
    */
  ...
  /* Optional */
  /*  Network Timers Indications */
  uint8_t network_enable_valid;  /**< Must be set to true if network_enable is being passed */
  uint8_t network_enable;
  /**<  0 – Disable
        1 – Enable
    */
}nas_swi_ind_register_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup swi_nas_qmi_messages
    @{
  */
/** Response Message; This message sets the registration state for different QMI_NAS  SWI indications. */
typedef struct {
  ...
  qmi_response_type_v01 resp;
  /**<   Standard response type.*/
}nas_swi_ind_register_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup swi_nas_qmi_messages
    @{
  */
/** Request Message; This command gets LTE CQI   */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}nas_swi_get_lte_cqi_req_msg_v01;
...
typedef struct {
  ...
  uint8_t validity_of_cw0;
  /**<  Validity of cw0
        0 – invalid
        1 – valid
    */

  uint8_t cqi_value_of_cw0;
  /**<  CQI value of cw0
        Range: 0 ~ 15
    */

  uint8_t validity_of_cw1;
  /**<  Validity of cw0
        0 – invalid
        1 – valid
    */

  uint8_t cqi_value_of_cw1;
  /**<  CQI value of cw1
        Range: 0 ~ 15
    */
}lte_cqi_type_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup swi_nas_qmi_messages
    @{
  */
/** Response Message; This command gets LTE CQI   */
typedef struct {
  ...
  /* Mandatory */
  /*  LTE CQI */
  lte_cqi_type_v01 lte_cqi;
}nas_swi_get_lte_cqi_resp_msg_v01;  /* Message */
/**
    @}
  */
#endif /* SIERRA */
...
/* SWISTART */
#ifdef SIERRA
//#define REMOVE_QMI_NAS_SWI_GET_LTE_ANT_CFG_V01
//#define REMOVE_QMI_NAS_SWI_GET_LTE_ANT_INFO_V01
//#define REMOVE_QMI_NAS_SWI_GET_LTE_CQI_V01
//#define REMOVE_QMI_NAS_SWI_INDICATION_REGISTER_V01
//#define REMOVE_QMI_NAS_SWI_MODEM_STATUS_V01
//#define REMOVE_QMI_NAS_SWI_OTA_MESSAGE_IND_V01
//#define REMOVE_QMI_NAS_SWI_RANK_INDICATOR_IND_V01
//#define REMOVE_QMI_NAS_SWI_SET_LTE_ANT_CFG_V01
#endif /* SIERRA */
/* SWISTOP */
...
/* SWISTART */
#ifdef SIERRA
#define QMI_NAS_SWI_MODEM_STATUS_REQ_V01 0x5556
#define QMI_NAS_SWI_MODEM_STATUS_RESP_V01 0x5556
#define QMI_NAS_SWI_GET_LTE_ANT_INFO_REQ_V01 0x5557
#define QMI_NAS_SWI_GET_LTE_ANT_INFO_RESP_V01 0x5557
#define QMI_NAS_SWI_SET_LTE_ANT_CFG_REQ_V01 0x5558
#define QMI_NAS_SWI_SET_LTE_ANT_CFG_RESP_V01 0x5558
#define QMI_NAS_SWI_GET_LTE_ANT_CFG_REQ_V01 0x5559
#define QMI_NAS_SWI_GET_LTE_ANT_CFG_RESP_V01 0x5559
#define QMI_NAS_SWI_INDICATION_REGISTER_REQ_V01 0x5566
#define QMI_NAS_SWI_INDICATION_REGISTER_RESP_V01 0x5566
#define QMI_NAS_SWI_OTA_MESSAGE_IND_V01 0x5567
#define QMI_NAS_SWI_RANK_INDICATOR_IND_V01 0x556A
#define QMI_NAS_SWI_GET_LTE_CQI_REQ_V01 0x7561
#define QMI_NAS_SWI_GET_LTE_CQI_RESP_V01 0x7561
#endif /* SIERRA */
/* SWISTOP */
/**
    @}
