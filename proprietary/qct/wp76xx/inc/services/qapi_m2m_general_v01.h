...
/* This file was generated with Tool version 6.13 
   It was generated on: Mon Jul  3 2017
...
#define QAPI_M2M_GENERAL_V01_MAX_MESSAGE_ID 0x00E0
/**
    @}
  */
...
#define QMI_SWI_M2M_MSG_MAX_V01 10
/**
    @}
  */
...
typedef struct {
  ...
  /**<  
    ...
    0 每 The RI owned by Modem core
    1 每 The RI owned by application core
  */
...
typedef struct {
  ...
  /**<   RF band 3GPP band number. For a full listing of 3GPP band numbers, see 3GPP bands table below.
                            Valid range: 0每60. Band support is product specific 〞 see the device＊s Product Specification or Product Technical Specification document for details.
                       */
...
typedef struct {
  ...
  uint8_t band_ind_4;
  /**<  
                        Availability is device-specific 〞 see the appropriate Product Technical Specification for details.
                        */
...
typedef struct {
  ...
  /**<  
                                     0 – Disable TXBURST indication
                                     1 – Enable TXBURST indication
                                     */
...
typedef struct {
  ...
  /**<  
                                     0x01 每 FOTA, to check availability of FW Update
                                     */
...
typedef struct {
  ...
  uint8_t session_type;
  /**<  
                                 0x01 每 FOTA, to suspend FOTA session 
                                 0xFF 每 Suspend ongoing FOTA session 
...
typedef struct {
  ...
  uint8_t status;
  /**<        
                            0x01 每 No Firmware available
                            0x02 每Query Firmware Download
                            0x03 每 Firmware Downloading
                            0x04 每 Firmware downloaded
                            0x05 每Query Firmware Update
                            0x06 每 Firmware updating
                            0x07 每 Firmware updated
                             */

  uint8_t user_input_req;
  /**<  
                            Bit mask of available user inputs.
                            0x00 每 No user input required. Informational indication
                            0x01 每 Accept
                            0x02 每 Reject
                            */
...
typedef struct {
  ...
  uint8_t state;
  /**<        
                            0x01 每 OMA-DM AVMS Read Request
                            0x02 每 OMA-DM AVMS Change Request
                            0x03 每 OMA-DM AVMS Config Complete
                            */
...
typedef struct {
  ...
  /**<  
                            0x12 每 Module starts sending data to server
                            0x13 每 Authentication with the server
                            0x14 每 session with the server is ended
                            	*/
...
typedef struct {
  ...
  /**<  
                                0x00 每 DISABLED
                                0x01 每 ENABLED ACCEPT
                                0x02 每 ENABLED REJECT
                                */
...
typedef struct {
  ...
  uint8_t msg[QMI_SWI_M2M_MSG_MAX_V01];
  /**<
    event message
   */
...
/** @addtogroup qapi_m2m_general_qmi_messages
    @{
  */
/** Request Message; This message is used to query for jamming event report activation status */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}swi_m2m_jamming_get_event_report_req_msg_v01;
...
/** @addtogroup qapi_m2m_general_qmi_messages
    @{
  */
/** Response Message; This message is used to query for jamming event report activation status */
typedef struct {
  ...
  /* Mandatory */
  uint8_t event_report_status;
  /**<  
                                       0: Event report disabled
                                       1: Event report enabled
                                       */
}swi_m2m_jamming_get_event_report_resp_msg_v01;  /* Message */
...
//#define REMOVE_QMI_SWI_M2M_GNSS_GET_GNSSCONFIG_V01 
//#define REMOVE_QMI_SWI_M2M_GNSS_SET_GNSSCONFIG_V01 
...
//#define REMOVE_QMI_SWI_M2M_NVUP_APPLY_V01 
//#define REMOVE_QMI_SWI_M2M_NVUP_DELETE_V01 
//#define REMOVE_QMI_SWI_M2M_NVUP_PROGRAM_V01 
//#define REMOVE_QMI_SWI_M2M_NV_BACKUP_V01 
//#define REMOVE_QMI_SWI_M2M_NV_RESTORE_V01 
...
#define QMI_SWI_M2M_JAMMING_GET_EVENT_REPORT_REQ_V01 0x0037
#define QMI_SWI_M2M_JAMMING_GET_EVENT_REPORT_RESP_V01 0x0037
