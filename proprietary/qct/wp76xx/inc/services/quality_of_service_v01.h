...
/* SWISTART */
#ifdef SIERRA
/** @addtogroup swi_qos_qmi_messages
    @{
  */
/** Request Message; This command queries the current number of packets and bytes sent,
	 dropped and received for each UL, DL bearer and a sum of them for UL and
	 UL dropped direction in the modem.  */
typedef struct {

  /* Mandatory */
  /*  APN identifier (PDN profile number) */
  uint32_t pdp_profile_num;
  /**<  ID identifying the connected APN that the client would like to query the data statistic for */
}qos_swi_read_data_statistic_req_msg_v01;  /* Message */
/**
    @}
  */

/** @addtogroup swi_qos_qmi_aggregates
    @{
  */
typedef struct {
  ...
  uint32_t total_packet_sent;
  /**<  Sum of all packets sent  */

  uint32_t total_tx_packet_dropped;
  /**<  Sum of all (TX) packets dropped  */

  uint32_t total_packet_received;
  /**<  Sum of all packets received  */

  uint64_t total_byte_sent;
  /**<  Sum of all bytes sent  */

  uint64_t total_tx_byte_dropped;
  /**<  Sum of all (TX) bytes dropped  */

  uint64_t total_byte_received;
  /**<  Sum of all bytes received  */
}apn_summary_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t bearer_identifier;
  /**<  EPS bearer ID  */

  uint32_t bearer_ID_packet_sent;
  /**<  Number of sent packets for the EPS bearer ID */

  uint32_t bearer_ID_tx_packet_dropped;
  /**<  Number of dropped (TX) packets for the EPS bearer ID */

  uint64_t bearer_ID_byte_sent;
  /**<  Number of sent bytes for the EPS bearer ID */

  uint64_t bearer_ID_tx_byte_dropped;
  /**<  Number of dropped (TX) bytes for the EPS bearer ID */
}epn_statistic_type_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup swi_qos_qmi_messages
    @{
  */
/** Response Message; This command queries the current number of packets and bytes sent,
	 dropped and received for each UL, DL bearer and a sum of them for UL and
	 UL dropped direction in the modem.  */
typedef struct {
  ...
  /* Mandatory */
  /*  Data statistic summary for the entire APN */
  apn_summary_type_v01 apn_summary;

  /* Mandatory */
  /*  Data statistic per EPS bearer */
  uint32_t epn_statistic_len;  /**< Must be set to # of elements in epn_statistic */
  epn_statistic_type_v01 epn_statistic[QMI_QOS_MAX_QOS_SPECS_V01];
  /**<   Data statistic per EPS bearer */
}qos_swi_read_data_statistic_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup swi_qos_qmi_messages
    @{
  */
/** Request Message; This command queries extra APN parameters. */
typedef struct {

  /* Mandatory */
  /*  APN identifier (PDN context ID) */
  uint32_t pdp_profile_num;
  /**<  ID identifying the APN that the client would like to query the AMBR params */
}qos_swi_read_extra_apn_params_req_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  uint8_t apn_ambr_ul_ext;
  /**<  Extended APN AMBR uplink */

  uint8_t apn_ambr_dl_ext;
  /**<  Extended APN AMBR downlink */

  uint8_t apn_ambr_ul_ext2;
  /**<  Second Extended APN AMBR uplink */

  uint8_t apn_ambr_dl_ext2;
  /**<  Second Extended APN AMBR downlink */
}ambr_specified_apn_type_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup swi_qos_qmi_messages
    @{
  */
/** Response Message; This command queries extra APN parameters. */
typedef struct {
  ...
  /* Mandatory */
  /*  AMBR for a specified APN */
  ambr_specified_apn_type_v01 ambr_specified_apn;
}qos_swi_read_extra_apn_params_resp_msg_v01;  /* Message */
/**
    @}
  */
#endif /* SIERRA */
...
/* SWISTART */
#ifdef SIERRA
//#define REMOVE_QMI_QOS_SWI_READ_DATA_STATISTIC_V01
//#define REMOVE_QMI_QOS_SWI_READ_EXTRA_APN_PARAMS_V01
#endif /* SIERRA */
/* SWISTOP */
...
/* SWISTART */
#ifdef SIERRA
#define QMI_QOS_SWI_READ_DATA_STATISTIC_REQ_V01 0x5556
#define QMI_QOS_SWI_READ_DATA_STATISTIC_RESP_V01 0x5556
#define QMI_QOS_SWI_READ_EXTRA_APN_PARAMS_REQ_V01 0x5557
#define QMI_QOS_SWI_READ_EXTRA_APN_PARAMS_RESP_V01 0x5557
#endif /* SIERRA */
/* SWISTOP */
