...
#define QMI_CLIENT_TRANSPORT_ERR  (-17)
#define QMI_CLIENT_PARAM_ERR      (-18)
#define QMI_CLIENT_INVALID_CLNT   (-19)
#define QMI_CLIENT_FW_NOT_UP      (-20)
#define QMI_CLIENT_INVALID_SIG    (-21)
#define QMI_XPORT_BUSY_ERR        (-22)
