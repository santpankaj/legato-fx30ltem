...
/* This file was generated with Tool version 6.14.7 
   It was generated on: Wed Aug 26 2015 (Spin 0)
...
#define VOICE_V02_IDL_MINOR_VERS 0x46
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define VOICE_V02_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define VOICE_V02_MAX_MESSAGE_ID 0x006B
/**
    @}
  */
 ...
 */
  ...
  */
  ...
  /**<   eCall MSD. The eCall Minimum Set of Data (MSD) can contain up to 140-byte
       ASN.1 unaligned PER data as described in CEN EN 15722.
...
typedef enum {
  ...
  VOICE_CALL_MODIFIED_CAUSE_UPGRADE_DUE_TO_LOCAL_REQ_V02 = 0x01, /**<  Upgrade due to local request \n  */
  VOICE_CALL_MODIFIED_CAUSE_UPGRADE_DUE_TO_REMOTE_REQ_V02 = 0x02, /**<  Upgrade due to remote request \n  */
  VOICE_CALL_MODIFIED_CAUSE_DOWNGRADE_DUE_TO_LOCAL_REQ_V02 = 0x03, /**<  Downgrade due to local request \n  */
  VOICE_CALL_MODIFIED_CAUSE_DOWNGRADE_DUE_TO_REMOTE_REQ_V02 = 0x04, /**<  Downgrade due to remote request \n  */
  VOICE_CALL_MODIFIED_CAUSE_DOWNGRADE_DUE_TO_RTP_TIMEOUT_V02 = 0x05, /**<  Downgrade due to RTP timeout \n  */
  VOICE_CALL_MODIFIED_CAUSE_DOWNGRADE_DUE_TO_QOS_V02 = 0x06, /**<  Downgrade due to QOS \n  */
  VOICE_CALL_MODIFIED_CAUSE_DOWNGRADE_DUE_TO_PACKET_LOSS_V02 = 0x07, /**<  Downgrade due to packet loss \n  */
  ...
  VOICE_CALL_MODIFIED_CAUSE_DOWNGRADE_DUE_TO_GENERIC_ERROR_V02 = 0x0A, /**<  Downgrade due to general error \n  */
...
typedef struct {
  ...
  */
  ...
  /**<   eCall MSD. The eCall Minimum Set of Data (MSD) can contain up to 140-byte
       ASN.1 unaligned PER data as described in CEN EN 15722.
       Length range: 0 to 140.  Set the length to 0 for disabling this feature.
  */
...
typedef enum {
  ...
  VOICE_SPEECH_CODEC_EVS_NB_V02 = 0x0011, /**<  EVS  */
  VOICE_SPEECH_CODEC_EVS_WB_V02 = 0x0012, /**<  EVS_WB  */
  VOICE_SPEECH_CODEC_EVS_SWB_V02 = 0x0013, /**<  EVS_SWB  */
  VOICE_SPEECH_CODEC_EVS_FB_V02 = 0x0014, /**<  EVS_FB  */
 ...
 */
  ...
  */
  ...
  /**<   Speech codec type. Values: \n
      ...
      - VOICE_SPEECH_CODEC_EVS_NB (0x0011) --  EVS 
      - VOICE_SPEECH_CODEC_EVS_WB (0x0012) --  EVS_WB 
      - VOICE_SPEECH_CODEC_EVS_SWB (0x0013) --  EVS_SWB 
      - VOICE_SPEECH_CODEC_EVS_FB (0x0014) --  EVS_FB 
 */
...
typedef struct {
  ...
  */
  ...
  /**<   Call modified cause. Values: \n
      ...
      - VOICE_CALL_MODIFIED_CAUSE_UPGRADE_DUE_TO_LOCAL_REQ (0x01) --  Upgrade due to local request \n 
      - VOICE_CALL_MODIFIED_CAUSE_UPGRADE_DUE_TO_REMOTE_REQ (0x02) --  Upgrade due to remote request \n 
      - VOICE_CALL_MODIFIED_CAUSE_DOWNGRADE_DUE_TO_LOCAL_REQ (0x03) --  Downgrade due to local request \n 
      - VOICE_CALL_MODIFIED_CAUSE_DOWNGRADE_DUE_TO_REMOTE_REQ (0x04) --  Downgrade due to remote request \n 
      - VOICE_CALL_MODIFIED_CAUSE_DOWNGRADE_DUE_TO_RTP_TIMEOUT (0x05) --  Downgrade due to RTP timeout \n 
      - VOICE_CALL_MODIFIED_CAUSE_DOWNGRADE_DUE_TO_QOS (0x06) --  Downgrade due to QOS \n 
      - VOICE_CALL_MODIFIED_CAUSE_DOWNGRADE_DUE_TO_PACKET_LOSS (0x07) --  Downgrade due to packet loss \n 
      ...
      - VOICE_CALL_MODIFIED_CAUSE_DOWNGRADE_DUE_TO_GENERIC_ERROR (0x0A) --  Downgrade due to general error \n 
...
typedef struct {
  ...
  /**<   Network mode. Values: \n
       ...
       - 0x06 -- VOICE_NETWORK_MODE_ WLAN -- WLAN
  */
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Request Message; Allows the client to set the WWAN_911 Timer value. When the UE is capable of making E911-VOIP over WiFi,
    it shall start a WWAN_911 Timer and WWAN search, and followed by WLAN search when WWAN_911 timer expired. */
typedef struct {
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Response Message; Allows the client to set the WWAN_911 Timer value. When the UE is capable of making E911-VOIP over WiFi,
    it shall start a WWAN_911 Timer and WWAN search, and followed by WLAN search when WWAN_911 timer expired. */
typedef struct {
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Request Message; Allows the client to get the last known WWAN-911 Timer value. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Response Message; Allows the client to get the last known WWAN-911 Timer value. */
typedef struct {
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Indication Message; Informs clients about the status of eCall. */
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  Minimum Set of Data (MSD) Transmission Status */
  ...
  /**<   Minimum Set of Data (MSD) Transmission Status. Values: \n
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Indication Message; Notifies clients about Call reestablishment status. */
typedef struct {

  /* Mandatory */
  /*  Call Reestablishment Status */
  call_reestab_status_enum_v02 status;
  /**<   Status of Call Re-establishment. Values: \n
