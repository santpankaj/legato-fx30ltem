...
*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  Copyright (c) 2006-2016 Qualcomm Technologies, Inc. All rights reserved.
...
#define WDS_V01_IDL_MINOR_VERS 0x76
...
typedef struct {
  ...
  */
  ...
  /**<   Status of the last MIP call (or attempt). Values: \n
       - 0x00 -- Success \n
       - 0 -- Error code (as defined in \hyperref[RFC2002]{RFC2002})
  */
...
typedef struct {
  ...
  */
  ...
  uint8_t local_abort;
  /**<   If set to 1 (TRUE), an OTA teardown request will not be 
       triggered by modem when the data call is torn down and will 
       only result in local clean up of PDN on UE. The default value 
       is 0 (FALSE) which will trigger OTA teardown in addition to 
       local clean up of PDN.
  */
 ...
 */
  ...
  */
  ...
  uint8_t persistent_valid;  /**< Must be set to true if persistent is being passed */
  uint8_t persistent;
  /**<   Boolean value used to indicate whether the 
...
#define WDS_3GPP_MASK_GSM_V01 ((wds_3gpp_rat_mask_v01)0x0000000000000001ull) 
#define WDS_3GPP_MASK_WCDMA_V01 ((wds_3gpp_rat_mask_v01)0x0000000000000002ull) 
#define WDS_3GPP_MASK_LTE_V01 ((wds_3gpp_rat_mask_v01)0x0000000000000004ull) 
#define WDS_3GPP_MASK_TDCDMA_V01 ((wds_3gpp_rat_mask_v01)0x0000000000000008ull) 
#define WDS_3GPP_MASK_ANY_V01 ((wds_3gpp_rat_mask_v01)0x8000000000000000ull) 
/** @addtogroup wds_qmi_messages
    @{
  */
/** Request Message; Requests modem to bring up always-on PDN when LTE is in full service */
typedef struct {
  ...
  /**<   3GPP profile index to be used for always-on PDN bringup.
       A value of 0 (default) instructs modem to use default profile.
  */
  ...
  /**<   RAT mask specifies on which 3GPP RAT types always-on PDN bringup will happen.
 Values:\n
      - WDS_3GPP_MASK_GSM (0x0000000000000001) -- 
      - WDS_3GPP_MASK_WCDMA (0x0000000000000002) -- 
      - WDS_3GPP_MASK_LTE (0x0000000000000004) -- 
      - WDS_3GPP_MASK_TDCDMA (0x0000000000000008) -- 
      - WDS_3GPP_MASK_ANY (0x8000000000000000) -- 
 */
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Response Message; Requests modem to bring up always-on PDN when LTE is in full service */
typedef struct {
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Request Message; Requests modem to tear down always-on PDN */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Response Message; Requests modem to tear down always-on PDN */
typedef struct {
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Request Message; Resets and Changes the settings in a configured profile. */
typedef struct {
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Response Message; Resets and Changes the settings in a configured profile. */
typedef struct {
...
typedef enum {
  ...
  WDS_V4_ADDR_DONTCARE_AND_V6_ADDR_DONTCARE_V01 = 0, 
  WDS_V4_ADDR_MANDATORY_AND_V6_ADDR_DONTCARE_V01 = 1, 
  WDS_V6_ADDR_MANDATORY_AND_V4_ADDR_DONTCARE_V01 = 2, 
  WDS_V4_ADDR_MANDATORY_AND_V6_ADDR_MANDATORY_V01 = 3, 
  WDS_V4_ADDR_MANDATORY_OR_V6_ADDR_MANDATORY_V01 = 4, 
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Request Message; Requests modem to set LTE attach profile related information */
typedef struct {
 ...
 */
  ...
  */
  ...
  /**<   Lets the modem know if the configuration is the last attach 
 configuration along with the action that needs to be taken
 Values: \n
 ...
 */
 ...
 Values: \n 
      - WDS_V4_ADDR_DONTCARE_AND_V6_ADDR_DONTCARE (0) -- 
      - WDS_V4_ADDR_MANDATORY_AND_V6_ADDR_DONTCARE (1) -- 
      - WDS_V6_ADDR_MANDATORY_AND_V4_ADDR_DONTCARE (2) -- 
      - WDS_V4_ADDR_MANDATORY_AND_V6_ADDR_MANDATORY (3) -- 
      - WDS_V4_ADDR_MANDATORY_OR_V6_ADDR_MANDATORY (4) --  */
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Response Message; Requests modem to set LTE attach profile related information */
typedef struct {
