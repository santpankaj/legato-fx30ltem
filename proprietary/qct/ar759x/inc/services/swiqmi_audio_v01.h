...
/* This file was generated with Tool version 6.2 
   It was generated on: Thu Aug 31 2017 (Spin 1)
...
#define SIERRA_M2M_AUDIO_API_V01_MAX_MESSAGE_ID 0x0057;
/** 
    @} 
  */
...
typedef struct {
  ...
  /* Mandatory */
  /*  Volte local ring back tone mute */
  uint8_t lrbtmute;
  /**<   0 – mute
                                 1 – unmute
                           */
...
typedef struct {
  ...
  /* Optional */
  /*  Volte local ring back tone mute */
  uint8_t lrbtmute_valid;  /**< Must be set to true if lrbtmute is being passed */
  uint8_t lrbtmute;
  /**<   0 – mute
                                1 – unmute
                           */
...
/** @addtogroup sierra_m2m_audio_api_qmi_messages
    @{
  */
/** Request Message; Thhis message requests to default specific profile or all profiles¡¯ audio calibration data as static value. */
typedef struct {
  ...
  /**<  
    Profile id
  */
}swi_m2m_audio_avblgen_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup sierra_m2m_audio_api_qmi_messages
    @{
  */
/** Response Message; Thhis message requests to default specific profile or all profiles¡¯ audio calibration data as static value. */
typedef struct {

  /* Mandatory */
  /*  Result Code */
  qmi_response_type_v01 resp;
}swi_m2m_audio_avblgen_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup sierra_m2m_audio_api_qmi_messages
    @{
  */
/** Request Message; The message requests to register audio relate indications, corresponding indication would receive from service after register.. */
typedef struct {

  /* Optional */
  /*  dtmf_events */
  uint8_t dtmf_events_valid;  /**< Must be set to true if dtmf_events is being passed */
  uint8_t dtmf_events;
  /**<  
    Values:
    0 - Disable (default)
  ...
  */
  ...
  /* Optional */
  /*  av_play_events */
  uint8_t av_play_events_valid;  /**< Must be set to true if av_play_events is being passed */
  uint8_t av_play_events;
  /**<  
    Values:
    0 - Disable (default)
    1 - Enable
  */
  ...
  /* Optional */
  /*  av_ready_event */
  uint8_t av_ready_event_valid;  /**< Must be set to true if av_ready_event is being passed */
  uint8_t av_ready_event;
  /**<  
    Values:
    0 - Disable (default)
    1 - Enable
  */
}swi_m2m_audio_indication_register_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup sierra_m2m_audio_api_qmi_messages
    @{
  */
/** Response Message; The message requests to register audio relate indications, corresponding indication would receive from service after register.. */
typedef struct {

  /* Mandatory */
  /*  Result Code */
  qmi_response_type_v01 resp;
}swi_m2m_audio_indication_register_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup sierra_m2m_audio_api_qmi_messages
    @{
  */
/** Indication Message; This message indicate audio initiation is done. */
typedef struct {
  ...
  /**<  
    ...
    1 - Ready
  */
}swi_m2m_audio_ready_ind_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup sierra_m2m_audio_api_qmi_msg_ids
    @{
  */
#define QMI_QAPI_PING_REQ_V01 0x0000
#define QMI_QAPI_PING_RESP_V01 0x0000
#define QMI_QAPI_PING_IND_V01 0x0000
...
#define QMI_SWI_M2M_AUDIO_GET_WDDMRESP_V01 0x0030
...
#define QMI_SWI_M2M_AUDIO_AVBLGEN_REQ_V01 0x0055
#define QMI_SWI_M2M_AUDIO_AVBLGEN_RESP_V01 0x0055
#define QMI_SWI_M2M_AUDIO_INDICATION_REGISTER_REQ_V01 0x0056
#define QMI_SWI_M2M_AUDIO_INDICATION_REGISTER_RESP_V01 0x0056
#define QMI_SWI_M2M_AUDIO_READY_IND_V01 0x0057
/**
    @}
  */
