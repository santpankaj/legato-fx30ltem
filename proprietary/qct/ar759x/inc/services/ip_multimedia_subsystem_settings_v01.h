...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //source/qcom/qct/interfaces/qmi/imss/main/latest/api/ip_multimedia_subsystem_settings_v01.h#41 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14
   It was generated on: Fri Oct 17 2014 (Spin 1)
...
#define IMSS_V01_IDL_MINOR_VERS 0x1C
...
typedef struct {
  ...
  /**<   SIP timer B's value, in milliseconds. If this TLV is not included in the
  ...
  /**<   SIP GZIP decoding outbuffer multiplier, the compression multiplier value.
...
typedef struct {
 ...
 TLV is not present in the request, a value of IMS_SETTINGS_VT_QUALITY_LEVEL_0
 (i.e., high quality) is used. Values: \n
...
/** @addtogroup imss_qmi_messages
    @{
  */
/** Indication Message; Indicates when the client provisioning configuration parameters change. */
typedef struct {
