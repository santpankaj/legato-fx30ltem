...
#define SIERRA_SWI_BSP_API_V01_MAX_MESSAGE_ID 0x0005
/** 
    @} 
  */


/** @addtogroup sierra_swi_bsp_api_qmi_consts 
    @{ 
  */
#define QMI_SWI_BSP_VERSIONS_TYPE_VALUE_SIZE_V01 512
/**
    @}
  */
...
typedef struct {
  ...
  /**<  
    Possible range is from 1 to max of uint8 (
    actual number varied by product).
   */
...
typedef struct {
  ...
  uint16_t adc_value;
  /**<  
    The ADC value measured for the requested ADC.
...
typedef struct {
  ...
  /**<  
    ...
    */
}swi_bsp_versions_read_req_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  /* Mandatory */
  /*  versions_value */
  uint8_t versions_value[QMI_SWI_BSP_VERSIONS_TYPE_VALUE_SIZE_V01];
}swi_bsp_versions_read_resp_msg_v01;  /* Message */
/**
    @}
  */
...
#define QMI_SWI_BSP_VERSIONS_READ_REQ_V01 0x0005
#define QMI_SWI_BSP_VERSIONS_READ_RESP_V01 0x0005
/**
    @}
  */
