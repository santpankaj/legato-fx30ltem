...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //source/qcom/qct/interfaces/qmi/uim/main/latest/api/user_identity_module_v01.h#49 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
/* This file was generated with Tool version 6.13 
   It was generated on: Mon Oct 20 2014 (Spin 0)
...
#define UIM_V01_IDL_MINOR_VERS 0x2D
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define UIM_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define UIM_V01_MAX_MESSAGE_ID 0x0059
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  /**<   Indicates whether the session information, file_id and data read
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  Read Result including request info */
  ...
  /**<   Read request info and content;
       session information, file_id and sequence of bytes as read
       from the card.
       See Annex D.5 for details on the result format.
  */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Request Message; Performs temporary unlock or unlock without CK of the phone */
typedef struct {

  /* Mandatory */
  /*  Encrypted value of the secure depersonalization request */
  ...
  /**<   See Annex D.1 for details on the request format */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Response Message; Performs temporary unlock or unlock without CK of the phone */
typedef struct {
  ...
  */
  ...
  /**<   See Annex D.6 for details on the response format */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Request Message; Activates and locks device to SIM Lock codes */
typedef struct {
  ...
  /**<   See Annex D.2 for details on the request format */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Response Message; Activates and locks device to SIM Lock codes */
typedef struct {
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Request Message; Sets the phone in the emergency only mode */
typedef struct {

  /* Mandatory */
  /*  Encrypted value of the request */
  ...
  /**<   See Annex D.3 for details on the request format */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Response Message; Sets the phone in the emergency only mode */
typedef struct {
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Request Message; Provides the access to the simlock configuration data */
typedef struct {

  /* Mandatory */
  /*  Encrypted value of the simlock configuration request */
  ...
  /**<   See Annex D.4 for details on the request format */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Response Message; Provides the access to the simlock configuration data */
typedef struct {
...
typedef struct {
  ...
  /**<   See Annex D.4 for details on the indication format */
...
typedef struct {
  ...
  /*  Slot */
  uim_slot_enum_v01 slot;
  /**<   Indicates the slot for which EID is requested. Valid values:\n
