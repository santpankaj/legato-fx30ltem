...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/4.1/nas/api/network_access_service_v01.h#27 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.7 
   It was generated on: Thu Jan 14 2016 (Spin 0)
...
#define NAS_V01_IDL_MINOR_VERS 0x9B
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define NAS_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
/* SWISTART */
#ifndef SIERRA
#define NAS_V01_MAX_MESSAGE_ID 0x00B6
#else
#define NAS_V01_MAX_MESSAGE_ID 0x7564
#endif
/* SWISTOP */
/**
    @}
...
typedef struct {
  ...
  */
  ...
  /**<   ECIO delta at which an event report indication,
       ...
       value that increments in negative 0.5 dB, for example, ecio_delta of
...
typedef struct {
  ...
  */
  ...
  /**<   LTE SNR delta level at which an event report indication, including the
       ...
       of 0.1 dB, for example, lte_snr_delta of 3 means a change 0.3 dB.
  */
...
typedef struct {
  ...
  uint8_t ecio;
  /**<   ECIO value representing negative 0.5 dB increments, that is, 
...
typedef struct {
  ...
  /**<   Error rate value corresponds to the RAT that is currently registered. \n
         ...
         - Valid error rate values between 1 and 10000 are returned to indicate 
            percentage, for example, a value of 300 means the error rate is 3% \n
         ...
         - The reported value divided by 100 gives the error rate as an RxQual 
            ...
            for example, a value of 300 represents an RxQual value of 3 \n
         ...
         - The reported value divided by 100 provides the error rate in 
            percentages, for example, a value of 300 represents a BLER of 3% \n
...
typedef enum {
  ...
  NAS_SCAN_TYPE_PCI_V01 = 0x03, /**<  PCI \n  */
...
typedef struct {
  ...
  */
  ...
  int8_t time_zone;
  /**<   Offset from Universal time, that is, difference between local
...
typedef struct {
  ...
  int8_t time_zone;
  /**<   Offset from Universal time, that is, difference between local time
...
typedef struct {
  ...
  */
  ...
  /**<   Roaming preference to be set. Values: \n
       ...
       - 0x03 -- ROAMING_PREF_NOT_FLASING -- Acquire only systems for which the roaming indicator is off or solid on, (not flashing); CDMA only \n
 ...
 */
  ...
  /**<    When TRUE, indicates that the UE cannot process the 
       request due to an LPM transition, the lower layer is busy, and so on.
...
typedef enum {
  ...
  NAS_LTE_DISABLE_CAUSE_PERMANENT_DS_V01 = 0x01, /**<  LTE is disabled by DS permanently, for example, T3316 expiry \n  */
...
typedef struct {
  ...
  */
  ...
  /**<   Roaming preference to be set. Values: \n
       - 0x01 -- ROAMING_PREF_OFF         -- Acquire only systems for which the roaming indicator is off \n
       - 0x02 -- ROAMING_PREF_NOT_OFF     -- Acquire a system as long as its roaming indicator is not off \n
       - 0x03 -- ROAMING_PREF_NOT_FLASING -- Acquire only systems for which the roaming indicator is off or solid on, that is, not flashing; CDMA only \n
       - 0xFF -- ROAMING_PREF_ANY         -- Acquire systems, regardless of their roaming indicator
  */
  ...
  */
  ...
  /**<   Country's initials. Values: \n
       ...
       - 0x01 -- COUNTRY_INITIALS_ADD -- MS adds the letters for the 
                 country's initials and a separator, for example, a space, to the text 
                 string
  */
...
typedef struct {
  ...
  /**<   Current RSRQ in 1/10 dB as measured by L1.  
    Range: -200 to -30 (for example, -200 means -20.0 dB). */

  int16_t rsrp;
  /**<   Current RSRP in 1/10 dBm as measured by L1. 
    Range: -1400 to -440 (for example, -440 means -44.0 dBm). */

  int16_t rssi;
  /**<   Current RSSI in 1/10 dBm as measured by L1.
    Range: -1200 to 0 (for example, -440 means -44.0 dBm). */
...
typedef struct {
  ...
  /**<   Measured RSSI value in 1/10 dB. 
    Range: -2000 to 0  (for example, -800 means -80.0 dB). */
...
typedef struct {
  ...
  /**<   Absolute power level (in 1/10 dBm) of the common pilot channel as 
    received by the UE. Range: -1200 to -250 (for example, -250 means -25.0 dBm). 
  ...
  /**<   CPICH Ec/No; ratio (in 1/10 dB) of the received energy per PN chip for 
    ...
    connector. Range: -500 to 0 (for example, -25 means -2.5 dB). Defined in 
...
typedef struct {
  ...
  uint8_t time_zone_valid;  /**< Must be set to true if time_zone is being passed */
  int8_t time_zone;
  /**<   Offset from Universal time, that is, the difference between local time
       and Universal time, in increments of 15 min (signed value).
  */
...
typedef struct {
 ...
 available from the lower layers; for example, if the UE powers up while acquiring 
 ...
 */
  ...
  /**<  
      ...
      - Each ECIO threshold value increments in negative 0.5 dB, 
        for example, an ECIO threshold value of 2 means -1 dB. \n
...
typedef struct {
  ...
  /**<  
      ...
      indicate the percentage, for example, a value of 300 means the error rate is 3%. 
...
typedef struct {
  ...
  */
  ...
  uint16_t freq;
  /**<   Frequency of the absolute cell. Range: 0 to 65535.
  */
...
typedef struct {
  ...
  */
  ...
  /**<   List of the user-configured LTE bands, ordered by priority. The ordering 
       ...
       - 120 to 161 -- LTE band classes (see Table @latexonly\ref{tbl:bandClass}@endlatexonly for details)
  */
...
typedef struct {
  ...
  /**<   Access control barring factor multiplied by 100, that is, 5 means 0.05 
...
typedef enum {
  ...
  NAS_SET_MCC_STATUS_DETECTION_DISABLED_V01 = 0x01, /**<  All mechanisms used to detect the MCC (Wi-Fi\regns, GPS, and so on) are 
 ...
 */
  ...
  /**<   MCC detection status. Values: \n
      ...
      - NAS_SET_MCC_STATUS_DETECTION_DISABLED (0x01) --  All mechanisms used to detect the MCC (Wi-Fi\regns, GPS, and so on) are 
       disabled by the user or control points \n 
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; Retrieves the HDR sector ID, pilot pseudo-random noise, 
	           and MAC index. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Response Message; Retrieves the HDR sector ID, pilot pseudo-random noise, 
	           and MAC index. */
typedef struct {
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; Sets radio policy manager (RPM) details, if the RPM is active. */
typedef struct {
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Response Message; Sets radio policy manager (RPM) details, if the RPM is active. */
typedef struct {
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; Retrieves the radio policy manager details if RPM is active. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Response Message; Retrieves the radio policy manager details if RPM is active. */
typedef struct {
  ...
  /**<   Maximum number of application resets.  \n
       Range: 1 to 16 (the default is 3).
  */
  ...
  uint16_t avg_reject_time;
  /**<   Average rejection time (seconds). \n
       Range 0 to 360 (the default is 120).
  */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; Enables and disables the radio policy manager. */
typedef struct {

  /* Mandatory */
  /*  RPM State */
  uint8_t rpm_state;
  /**<   Desired status of the RPM. Values: \n
       - 0x00 -- Disabled \n
       - 0x01 -- Enabled
  */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Response Message; Enables and disables the radio policy manager. */
typedef struct {
...
/** Indication Message; Informs the control point that the manual network search
             could not find any networks with the given parameters. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
 ...
 */
  ...
  /**<   Indicates whether LTE ECBM is required by a NV setting. Values: \n
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; Triggers a de-registration operation for a ECall. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Response Message; Triggers a de-registration operation for a ECall. */
typedef struct {
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; This API will update the specified Carrier aggregation band combo string for a PLMN. */
typedef struct {
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Response Message; This API will update the specified Carrier aggregation band combo string for a PLMN. */
typedef struct {
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; This API will allow get the specified carrier aggregation band combo string 
              for a given PLMN.
. */
typedef struct {
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Response Message; This API will allow get the specified carrier aggregation band combo string 
              for a given PLMN.
. */
typedef struct {
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; This API will allow APPS to request the timer to start again and give the remaining time for which the timer has to run.
. */
typedef struct {
 ...
 */
  ...
  /*  Duration */
  uint32_t duration;
  /**<   seconds for which timer should run
  */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Response Message; This API will allow APPS to request the timer to start again and give the remaining time for which the timer has to run.
. */
typedef struct {
...
/* SWISTART */
#ifdef SIERRA
/*Since the new QMI is based on QCT's QMI_NAS_SET_FORBIDDEN_NETWORK_REQ, the parameter struct is
the same with the QCT's QMI, we will not add a new parameter struct, only typedef the below type for the new QMI*/
typedef nas_set_forbidden_networks_req_msg_v01  nas_swi_set_forbidden_network_req_msg_v01;
typedef nas_set_forbidden_networks_resp_msg_v01 nas_swi_set_forbidden_network_resp_msg_v01;
#endif
/* SWISTOP */
...
/* SWISTART */
#ifdef SIERRA
#define QMI_NAS_SWI_SET_FORBIDDEN_NETWORK_REQ_V01 0x7564
#define QMI_NAS_SWI_SET_FORBIDDEN_NETWORK_RESP_V01 0x7564
#endif
/* SWISTOP */
